   ...
   public function index(Request $request)
    {
        ...
        $data['paginate_data'] =ItemUnitModel::valid()->when($search_key, function($query, $search_key){
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($request->id)){
            ...
            $save =  ItemUnitModel::findOrFail($request->id)->update($data);
            ...
            $save = ItemUnitModel::create($data);  
    ...
    public function edit(Request $request)
    {
        ...
        $project = ItemUnitModel::valid()->findOrFail($request->id);
        $project->password = "";
