...
class TalentPeopleController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Talent::query()->with('department');
    ...
    public function destroy($id)
    {
        ...
        $talent = Talent::query()->findOrFail($id);
    ...
    public function send($id)
    {
        ...
        Mail::to($talent->email)->send(new TalentedPeopleMail());
