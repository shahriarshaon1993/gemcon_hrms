                    ...
                    <div id="printable">
                      ...
                      >
                        ...
                        <tbody>
                          <tr v-for="(data, index) in alldata" v-bind:key="index">
                            ...
                            <td class="ths text-right">{{ data.total_a_wages.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_b_wages.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_c_wages.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_wages.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.bonus_hands.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.bonus_amount.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.wages_and_bonus.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_dad.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.salary_loan.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_canteen_deduct.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_appron.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_deduction.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.net_wages.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.top_sheet_remarks }}</td>
                            <td class="ths text-right">{{ data.top_sheet_head }}</td>
                          </tr>
                        </tbody>
                      </table>
                      ...
                      >
                        <thead>
                          <tr style="background: #eee">
                            ...
                            <th class="ths text-center">Signature</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr v-for="(data, index) in alldata" v-bind:key="index">
                            ...
                            <td class="ths"></td>
                            <td class="ths">{{ data.department_name }}</td>
                            <td class="ths text-right">{{ data.total_wages }}</td>
                            <td class="ths text-right">{{ data.total_dad }}</td>
                            <td class="ths text-right">{{ data.salary_loan }}</td>
                            <td class="ths text-right">{{ data.total_canteen_deduct }}</td>
                            <td class="ths text-right"></td>
                            <td class="ths text-right">{{ data.total_deduction }}</td>
                            <td class="ths text-right">{{ data.net_wages }}</td>
                            <td class="ths"></td>
                            <td class="ths"></td>
                            <td class="ths"></td>
                            <td class="ths"></td>
                        ...
                        <tfoot>
                          <tr>
                            <th class="ths" colspan="3"></th>
                            <th class="ths text-right"><b>{{ total_gross_wages }}</b></th>
                            <th class="ths text-right"><b>{{ total_dad_wages }}</b></th>
                            <th class="ths text-right"><b>{{ total_loan_deduct }}</b></th>
                            <th class="ths text-right"><b>{{ total_canteen_deduct }}</b></th>
                            <th class="ths text-right"><b>{{ total_tic_deduct }}</b></th>
                            <th class="ths text-right"><b>{{ total_total_deduct }}</b></th>
                            <th class="ths text-right"><b>{{ total_net_amount }}</b></th>
                            <th class="ths"></th>
                            <th class="ths"></th>
                            <th class="ths"></th>
                            <th class="ths"></th>
                      ...
                      >
                        ...
                        <tbody>
                          <tr v-for="(data, index) in alldata" v-bind:key="index">
                            <td class="ths text-center">{{ data.department_name }}</td>
                            <td class="ths text-right">{{ data.a_deduction_loan.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.b_deduction_loan.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.c_deduction_loan.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_loan_deduction.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.a_deduction_canteen.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.b_deduction_canteen.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.c_deduction_canteen.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_canteen_deduction.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.a_deduction_uniform.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.b_deduction_uniform.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.c_deduction_uniform.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_uniform_deduction.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.a_deduction_others.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.b_deduction_others.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.c_deduction_others.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_others_deduction.toFixed(2) }}</td>
                            <td class="ths text-right">{{ data.total_others_deduction.toFixed(2) }}</td>
                          </tr>
                        </tbody>
                      </table>
