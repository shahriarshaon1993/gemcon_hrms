...
use App\Http\Resources\MosdatauserResource;
class MosUserTreeResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "mosuserachievementjoin" => New MosdatauserResource($this->mosuserachievementjoin),
