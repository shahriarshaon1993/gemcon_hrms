...
function websdkready() {
  ...
  var API_KEY = "r9AQVglkQiqnn4oW5ZiF7w";
   ...
   */
  var API_SECRET = "Q9bagY04Cl0gUgURuLQwmgvQqvs5ydmkWMbv";
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        apiKey: 'r9AQVglkQiqnn4oW5ZiF7w',
        apiSecret: 'Q9bagY04Cl0gUgURuLQwmgvQqvs5ydmkWMbv',
        role: meetingConfig.role,
        success: function (res) {
          console.log(res.result);
          meetingConfig.signature = res.result;
          meetingConfig.apiKey = API_KEY;
          var joinUrl = "/zoom_meeting_connect/" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
          console.log(joinUrl);
