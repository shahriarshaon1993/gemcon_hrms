...
Vue.component('header-top', require('./components/pages/HeaderTop.vue').default);
Vue.component('admin-sidebar', require('./components/admin/AdminSidebar.vue').default);
Vue.component('frontend-header', require('./components/appraisal/FrontendHeader.vue').default);
Vue.component('frontend-footer', require('./components/appraisal/FrontendFooter.vue').default);
