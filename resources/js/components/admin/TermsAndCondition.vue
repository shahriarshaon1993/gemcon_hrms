...
<div>
    <div v-if="page_loading" class="widget box">
        <div class="widget-header">
            <h4><i class="icon-reorder"></i> Terms And Condition</h4>
            ...
            <div class="toolbar no-padding ">
                ...
                <modal name="myModal" width="900" height="auto" :clickToClose="false">
                    <div v-if="modal_loading">
                        <div class="widget-header">
                            <h4><i class="icon-reorder"></i> Terms And Condition Form</h4>
                        ...
                        <div class="modify-wraper">
                            <form @submit.prevent="add({add:'add/termsAndCondition'})" class="form-horizontal  row-border" id="validate-1">
                                <div class="pos-form-wraper">
                                    ...
                                    <div class="form-group modify-input">
                                        <label class="col-md-2 control-label">Purchase orders :</label>
                                        <div class="col-md-10">
                                             <textarea v-model="form_data.po_terms_condition" id="inv_comment" type="text" style="width: 99%;margin-left: 14px;height: 78px;margin-bottom: -10px;margin-top: -9px;line-height: 3.428571;" class="form-control textarea-height-set"></textarea>
                                        </div>
                                    </div>
                                    <br>
                                     <div class="form-group modify-input">
                                        <label class="col-md-2 control-label">POS Bill :</label>
                                        <div class="col-md-10">
                                             <textarea v-model="form_data.pos_terms_condition" id="inv_comment" type="text" style="width: 99%;margin-left: 14px;height: 78px;margin-bottom: -10px;margin-top: -9px;line-height: 3.428571;" class="form-control textarea-height-set"></textarea>
                                        </div>
                                    </div>
                                    <br>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody v-if="Object.keys(paginate_data.data).length > 0">
                        ...
                        <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id">
                            <td>{{index + 1}}</td>
                            <td>  {{form_data.po_terms_condition }}</td>
                            <td>  {{form_data.pos_terms_condition }}</td>
                            <td class="action">
                                <button @click="getModalData($event,{dataUrl:'edit/termsAndCondition/'+form_data.id})" class="btn-xs btn-info" data-toggle="modal" data-target="#myModal"><i class="icon-edit"></i> Edit</button>
                                <button @click="deleteItem({delUrl:'delete/termsAndCondition/'+form_data.id})" class="btn-xs btn-danger"><i class="icon-trash"></i> Delete</button>
                            </td>
                        </tr>
                    </tbody>
                    <tbody v-else>
