    ...
    <div v-if="page_loading" class="widget box">
        <div class="widget-header">
            ...
            <div class="toolbar no-padding ">
                <div @click="getModalData($event,{dataUrl:'create/role'})" class="btn-group"> <span class="btn btn-xs btn-info"><i class="icon-plus"></i>Add New</span> </div>
                ...
                <modal name="myModal"  transition="scale" width="550" height="auto" :clickToClose="false">
                    <div v-if="modal_loading">
                        <div class="widget-header">
                            <h4><i class="icon-reorder"></i>User Role</h4>
                        ...
                        <div class="modify-wraper">
                            <form @submit.prevent="add({add:'add/role'})" class="form-horizontal  row-border" id="validate-1">
                                <div class="my-form-wraper">
                                    <div class="form-group modify-input">
                                        ...
                                        <div class="col-md-5" :class="{ 'has-error': $v.form_data.role_name.$error }">
                                        ...
                                        <div class="col-md-4" >
                                            ...
                                            <select class="form-control " v-model="form_data.module" style="height: 32px;">
                                                <option v-for="module in form_data.Module"  :value='module.id' >{{module.module_name }}</option>
                                        ...
                                        <div class="widget-header">
                                            <h4>
                                                <label class="checkbox-inline" >
                                                    <input true-value="1" false-value="0" type="checkbox" @change="masterCheck" v-model="masterselect">User Panel
                                                </label>
                                            </h4>
                                        </div>
                                                            ...
                                                            <table v-for="sub in list.children" class="responsive table table-striped table-bordered m-b-0" cellspacing="0">
                                                                <tbody>
                                                                    ...
                                                                    <tr v-if="option_data.internal_link[sub.id]">
                                                                        <td>
                                                                            <label class="checkbox-inline" ><input type="checkbox" true-value="1" false-value="0" v-model="form_data.selectAll" :value="sub.id"  @change="checkSelectAll(sub)">Select All</label>
                                                                            <hr>
                                                                            ...
                                                                            <table v-for="deep in sub.children" class="responsive table table-striped table-bordered m-b-0" cellspacing="0">
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr v-if="option_data.internal_link[deep.id]">
                                                                                        <td>
                                                                                            <label class="checkbox-inline" ><input type="checkbox" v-model="form_data.selectAll" :value="deep.id" @change="checkSelectAll(deep)">Select All</label>
                                                                                            <hr>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <td class="sortable" v-bind:class="getSortingClass('module')" @click="sortingChanged('module')">Module</td>
                    ...
                    <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                        <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id">
                            ...
                            <td>
                                <samp v-for="modules in lists.Module"> 
                                    <samp v-if="modules.id== form_data.module"> 
                                        {{ modules.module_name}}
                                    </samp>
                                </samp>
                                <!-- {{form_data.module}} -->
                            ...
                            <td style="width: 20%" class="action">
                                <button @click="getModalData($event,{dataUrl:'role/edit/'+form_data.id},editSlection)" class="btn-xs btn-info" title="" data-original-title="Edit" data-toggle="modal" data-target="#myModal"><i class="icon-edit"></i> Edit</button>
                                <button @click="deleteItem({delUrl:'role/delete/'+form_data.id})" class="btn-xs btn-danger" title="" data-original-title="Delete"><i class="icon-trash"></i> Delete</button>
                            </td>
                        </tr>   
                    </tbody>
                    <tbody v-else>
    ...
    export default {
        ...
        methods:{
            ...
            masterCheck(){
                ...
                this.form_data.masterselect = this.masterselect;
