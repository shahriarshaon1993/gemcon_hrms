                ...
                <modal name="myModal" width="550" height="auto" :clickToClose="false">
                    <div v-if="modal_loading">
                        ...
                        <div class="modify-wraper">
                                <form @submit.prevent="add({add:'add'})" class="form-horizontal  row-border" id="validate-1">
                                    <div class="my-form-wraper">
                                        ...
                                        <div class="form-group modify-input">
                                            ...
                                            <div class="col-md-9" :class="{ 'has-error': $v.form_data.name.$error }">
                                                ...
                                                <input v-model="form_data.name" type="text" class="form-control required" placeholder="Name">
                                            </div>
                                        </div>
                                         <div class="form-group modify-input">
                                            ...
                                            <div class="col-md-9" :class="{ 'has-error': $v.form_data.username.$error }">
                                                ...
                                                <input v-model="form_data.username" type="text" class="form-control required" placeholder="User Name">
                                            </div>
                                        </div>
                                        <div class="form-group modify-input">
                                            ...
                                            <div class="col-md-9" :class="{ 'has-error': $v.form_data.email.$error }">
                                                ...
                                                <input ref="input" v-model="form_data.email"  type="text" class="form-control required" placeholder="Email">
                                            </div>
                                        </div>
                                        <div v-if="form_data.id" class="form-group modify-input">
                                            <label class="col-md-3 control-label">Password</label>
                                            <div class="col-md-9">
                                                <input v-model="form_data.password"  type="password" class="form-control" placeholder="Password">
                                            </div>
                                        </div>
                                        <div v-if="!form_data.id" class="form-group modify-input">
                                            ...
                                            <div class="col-md-9" :class="{ 'has-error': $v.form_data.password.$error }">
                                                ...
                                                <input v-model="form_data.password"  type="password" class="form-control required" placeholder="Password">
                                            </div>
                                        </div>
                                        <div class="form-group modify-input">
