...
<div>
    <div v-if="page_loading" class="widget box">
        <div class="widget-header">
            <h4><i class="icon-reorder"></i>User Authentication</h4>
            ...
            <div class="toolbar no-padding ">
                ...
                <modal name="myModal" width="677" height="auto" :clickToClose="false">
                    <div v-if="modal_loading">
                        <div class="widget-header">
                            <h4><i class="icon-reorder"></i>User Authentication Form</h4>
                        ...
                        <div class="modify-wraper">
                            <form @submit.prevent="add({add:'add/UseAuthentication'})" class="form-horizontal  row-border" id="validate-1">
                                <div class="pos-form-wraper">
                                    ...
                                    <div class="form-group modify-input">
                                        ...
                                        <div class="col-md-6">
                                            <input v-model="form_data.user_name" type="text" class="form-control required">
                                        </div>
                                    </div>
                                    <div class="form-group modify-input">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody v-if="Object.keys(paginate_data.data).length > 0">
                        ...
                        <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id">
                            <td>{{index + 1}}</td>
                            <td>  {{form_data.user_name }}</td>
                            <td class="action">
                                <button @click="getModalData($event,{dataUrl:'edit/UseAuthentication/'+form_data.id})" class="btn-xs btn-info" data-toggle="modal" data-target="#myModal"><i class="icon-edit"></i> Edit</button>
                                <button @click="deleteItem({delUrl:'delete/UseAuthentication/'+form_data.id})" class="btn-xs btn-danger"><i class="icon-trash"></i> Delete</button>
                            </td>
                        </tr>
                    </tbody>
                    <tbody v-else>
