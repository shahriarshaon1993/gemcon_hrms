                ...
                <div class="content-header row">
                    <div class="content-header-left col-12 mb-1 mt-0">
                        <div class="row breadcrumbs-top">
                            ...
                            <div class=" col-sm-3">
                                <router-link :to="{ path: '/add_fac_work' }" class="btn btn-primary add-btn" v-if="dept_id == 24 || dept_id == 25 || dept_id == 27   || dept_id == 30  || dept_id == 69  ">
                                    <i class="bx bx-add-alt">
                                    </i>
                                    Fac Add
                                </router-link>
                                <router-link :to="{ path: '/add_daily_work' }" class="btn btn-primary add-btn" v-if="role_id != 10">
                                    <i class="bx bx-add-alt">
                                    </i>
                                    New Work Schedule
                                </router-link>
                                <router-link :to="{ path: '/new_tour' }" class="btn btn-primary add-btn" v-if="role_id == 10">
                                    <i class="bx bx-add-alt">
                                    </i>
                                    New Tour Plan
                                </router-link>
                ...
                <section id="basic-datatable">
                    <div class="content-body">
                        <div class="users-list-filter px-1">
                            <div class="row border rounded py-2 mb-2">
                                <div class="col-12 col-sm-6 col-lg-2">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-control" id="users-list-verified" v-model="filterForm.dept_id" v-on:change="filter_data()">
                                            <option value="">
                                                All
                                            </option>
                                ...
                                <div class="col-12 col-sm-6 col-lg-2">
                                    ...
                                    <fieldset class="form-group">
                                        <select class="form-control" id="users-list-verified" v-model="filterForm.filter_by">
                                            <option value="year">
                                                Year
                                            </option>
                            ...
                            <div class="row" v-if="filterForm.filter_by =='year'">
                                <div class="col-xl-4">
                                    <div class="card card_box">
                                        <apexchart :options="yearly_achievement.chartOptions" :series="achievement_with_remaining" height="500px" type="pie">
                                        </apexchart>
                                    </div>
                                </div>
                                <!-- //Performance management -->
                                <div class="col-xl-4" v-if="role_id == 1 || role_id == 2 || role_id == 3 || role_id == 4 || role_id == 8 || role_id == 5 ">
                                    <div class="card card_box">
                                        <apexchart :options="performance.chartOptions" :series="performance_value" ref="chart1" type="donut">
                                        </apexchart>
                                    </div>
                                </div>
                                <div class="col-xl-4" v-if="role_id == 1 || role_id == 2 || role_id == 3 || role_id == 4 || role_id == 8 || role_id == 5 ">
                                    <div class="card card_box">
                                        <apexchart :options="analytics_bar.chartOptions" :series="analytics_bar.series" ref="budget_analytics" type="bar">
                                        </apexchart>
                                    </div>
                                </div>
                            </div>
                            <div class="row" v-if="filterForm.filter_by =='quarter'">
                                <div class="col-xl-3">
                                    <div class="card">
                                        <apexchart :options="quarter_achievement_1.chartOptions" :series="achievement_1" height="500px" type="pie">
                                        </apexchart>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card">
                                        <apexchart :options="quarter_achievement_2.chartOptions" :series="achievement_2" height="500px" type="pie">
                                        </apexchart>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card">
                                        <apexchart :options="quarter_achievement_3.chartOptions" :series="achievement_3" height="500px" type="pie">
                                        </apexchart>
                                    </div>
                                </div>
                                <div class="col-xl-3">
                                    <div class="card">
                                        <apexchart :options="quarter_achievement_4.chartOptions" :series="achievement_4" height="500px" type="pie">
                                        </apexchart>
                                    </div>
                                </div>
                            </div>
                            <!-- //Dept Wise Monthly Activity -->
                            <div class="row" v-if="role_id == 1 || role_id == 2 || role_id == 3 || role_id == 4 || role_id == 8 ||  role_id == 5">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="card-body card-dashboard">
                                                <div class="px-2 py-2 text-center mycustomefont mycustomefont">
                                                    <b>
                                                        Department Wise Monthly Activity
                                                        <select @change="changeMonth()" id="Profession" name="month_index" v-model="month_index">
                                                            <option value="">
                                                                Select one
                                                            </option>
                                                            <option :key="index" :value="index" v-for="(row ,index) in monthNames">
                                                                {{ row}}
                                                            </option>
                                                        </select>
                                                    </b>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-sm">
                                                        <thead class="thead-dark">
                                                            <tr>
                                                                <th class="text-center">
                                                                    Department
                                                                    <input class="text-center" placeholder="Search" type="text" v-model="search"/>
                                                                </th>
                                                                <th>
                                                                    Target
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            <tr :key="index" v-for="(item , index ) in filteredItems">
                                                                <td @click="show_pop(item)" class="text-center">
                                                                    {{ item.name}}
                                                                    <i class="bx bx-detail btn primary" style="float: right;">
                                                                    </i>
                                                                </td>
                                                                <td class="text-right">
                                                                    {{ (item.target[current_monthstr] ? item.target[current_monthstr] : 0).toFixed(2) }}
                                                                </td>
                                                                <td class="text-right">
                                                                    {{ (item.achievement[current_monthstr] ? item.achievement[current_monthstr]  : 0 ).toFixed(2) }}
                                                                </td>
                                                                <td class="text-right">
                                                                     {{ Number(item.score[current_monthstr]).toFixed(2) }}
                                                                </td>
                                                                <!-- <td> {{ ((item.target[current_monthstr] ? item.target[current_monthstr] : 0 ) -  (item.achievement[current_monthstr] ? item.achievement[current_monthstr]  : 0)).toFixed(2) }}</td>                                                     -->
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                            ...
                            <modal height="84%" name="popup-singel" style="padding:50px" width="60%">
                                <i @click="hide_pop()" class="bx bx-x-circle x-circle">
                                </i>
                                <div class="app-content ">
                                    <div class="card">
                                        <apexchart :options="singel_analytics_bar.chartOptions" :series="dept_analytics_series" ref="dept_analytics" type="bar">
                                        </apexchart>
                                    </div>
                                </div>
                            </modal>
                        ...
                        .then(({
                            ...
                            if (data.success) { 
                               // setInterval(() => {
                                    ...
                                    this.achievement_with_remaining = this.target_achievement.achievement_with_remaining ;
                                    this.piecolor = this.target_achievement.color ;

                                    this.target = this.target_achievement.target ;
                                   // this.$localStorage.get("achievement")
                                    this.$localStorage.set("achievement", JSON.stringify(this.achievement) );
                                    this.$localStorage.set("target", JSON.stringify(this.target) );
                                    this.$localStorage.set("achievement_with_remaining", JSON.stringify(this.achievement_with_remaining) );
