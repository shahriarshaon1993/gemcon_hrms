            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <form @submit.prevent="add({add: 'add/bulkShiftingSetup'},resetModal1)" id="validate-1" >
                  ...
                  <div class="card-body col-md-12">
                    ...
                    <div class="row">
                     <div class="form-group col-md-2" style="max-width: 12%">
                      ...
                      <div class="form-group col-md-2" style="max-width: 12%">
                        <label class="col-md-12 control-label"
                          >Shift <sup style="color: red; top: -2px">*</sup></label
                        >
                        <div
                          class="col-md-12 inputGroupContainer"
                          style="padding: 0px"
                        ...
                        >
                          <div class="input-group">
                            ...
                            ></span>
                              <input
                              type="submit"
                              style="width: 130px; margin-bottom: 9px;color: rgb(33, 37, 41) !important; background-color: rgb(250, 194, 60); border-color: rgb(250, 194, 60); width: 50px; height: 30px;"
                              tabindex="4"
                              value="Save"
...
export default {
  ...
  methods: {
    ...
    resetModal1() {
      ...
      this.form_data.subsection_id='';
      this.form_data.subsection_id='';
      this.form_data.subunit_id='';
      this.form_data.unit_id='';
      this.form_data.employee_work_location='';
      this.form_data.department_id='';
      this.form_data.shift_id='';
