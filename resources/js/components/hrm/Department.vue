                  ...
                  <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center sortable" v-bind:class="getSortingClass('department_code')" @click="sortingChanged('department_code')">Department Code <i class="fas fa-sort"></i></th>
                        <th class="text-center sortable" v-bind:class="getSortingClass('department_name')" @click="sortingChanged('department_name')">Department Name <i class="fas fa-sort text-right"></i></th>
                        <th class="text-center sortable" v-bind:class="getSortingClass('total_dep_emp')" @click="sortingChanged('total_dep_emp')">No. of Emploee <i class="fas fa-sort text-right"></i></th>
                        <th class="text-center sortable" v-bind:class="getSortingClass('employee_fullname')" @click="sortingChanged('employee_fullname')">Department Head <i class="fas fa-sort text-right"></i></th>
                     ...
                     <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-center">{{form_data.total_dep_emp}}</td>
                        <td class="">{{form_data.employee_fullname}}</td>
                        <td class="text-center">{{form_data.priority}}</td>
                        <td class="text-center">
                          <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/department/'+form_data.id},setModalData)" class="btn btn-info btn-xs" title="Edit" > <i class="fa fa-edit"> </i> Edit </button>
                          <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/department/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
                           </td>
                      </tr>
                    </tbody>
                     <tbody v-else>
