                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Designation List</h3>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('designation_code')" @click="sortingChanged('designation_code')">Designation Code <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('designation_name')" @click="sortingChanged('designation_name')">Designation Name <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('designation_name_bangla')" @click="sortingChanged('designation_name_bangla')">Designation Name Bangla <i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('priority')" @click="sortingChanged('priority')">Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i = index>
                            ...
                            <td class="text-center">{{form_data.designation_code}}</td>
                            <td>{{form_data.designation_name}}</td>
                            <td>{{form_data.designation_name_bangla}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center">
                               <span v-if="form_data.designation_status==1">
                                {{"Active"}}
                              </span>
                              <span v-else>
                                {{"Inactive"}}
                            ...
                            <td class="text-center">
                              ...
                              <button  v-if="lists.edit=='edit'" class="btn btn-xs btn-info" @click="getModalData($event,{dataUrl:'edit/designation/'+form_data.id})" title="Edit" > <i class="fa fa-edit"> </i> Edit </button>
          ...
          <modal class="" width= "40%" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   <div class="widget-header modal-header">
                       <h4><i class="fa fa-bars"></i> Designation</h4>
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/designation'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="row" style="margin-right:0px">
                           <div class="col-md-12">
                              <div class="form-group">
                                 <label class="col-md-6 control-label">Designation Name</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="designation_name" v-model="form_data.designation_name" name="designation_name" placeholder="" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-md-6 control-label">Designation Name Bangla</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="designation_name" v-model="form_data.designation_name_bangla" name="designation_name" placeholder="" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group" v-if="form_data.id">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class="form-control" v-model="form_data.designation_status" required="true">
