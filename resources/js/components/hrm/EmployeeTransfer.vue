                ...
                <div >
                        ...
                        <div class="row">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                                            <h3 class="card-title d-none d-md-block">Employee Transfer List</h3>
                                            <span class="float-sm-right" style="float: right;">
                                            <div v-if="lists.add=='add'" @click="getModalData($event,{dataUrl:'create/leaveapplication'}, resetModal, add_new_type = 2)" class="btn-group"> <span class="btn btn-sm btn-info"><i class="icon-plus"></i>Transfer Request</span> </div>
                                ...
                                <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                                    ...
                                    <th class="text-center" v-bind:class="getSortingClass('leave_from_date')" @click="sortingChanged('leave_from_date')">Request Date <i class="fas fa-sort"></i></th>
                    ...
                    <div v-if="modal_loading">
                        <div class="widget-header modal-header">
                            <h4><i class="fa fa-bars"></i> Transfer Request</h4>
                                        ...
                                        <div class="row col-md-12" style="margin: 0px; padding-right: 0px">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="employeesSbuTransfer" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="onSelectDepartment1" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="employeesSection1" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="employeesSubSection1" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="employeesSubUnit1" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="onSelectDesignation" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="onSelectJobGrade" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="onSelectEmployee" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @select="employeesGroup1" placeholder="Select one" label="text" track-by="text">
                                                    </vue-select>
                                                </div>
                                                </div>
                                            </div>
