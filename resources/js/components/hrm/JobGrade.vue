                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Job Grade List</h3>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('jobgrade_code')" @click="sortingChanged('jobgrade_code')">Grade Code <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('jobgrade_name')" @click="sortingChanged('jobgrade_name')">Grade Name <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('employee_insurance_amount')" @click="sortingChanged('employee_insurance_amount')">Insurance Amount<i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('company_insurance_amount')" @click="sortingChanged('company_insurance_amount')">Yearly Premium Cost<i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('jobgrade_status')" @click="sortingChanged('jobgrade_status')">Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                            ...
                            <td class="text-center">{{form_data.jobgrade_code}}</td>
                            <td class="text-center">{{form_data.jobgrade_name}}</td>
                            <td class="text-center">{{form_data.insurance_amount}}</td>
                            <td class="text-center">{{form_data.yearly_premium_cost}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center">
                              <span v-if="form_data.jobgrade_status==1">
                                {{"Active"}}
                              </span>
                              <span v-else>
                                {{"Inactive"}}
                            ...
                            <td class="text-center">
                              <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/jobgrade/'+form_data.id})" class="btn btn-info btn-xs" title="Edit" data-toggle="modal" data-target="#addNewJobGrade" > <i class="fa fa-edit"> </i> Edit |</button>
                            
                              <button v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/jobgrade/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
                               </td>
                          </tr>
                        </tbody>
                         <tbody v-else>
          ...
          <modal class="" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   <div class="widget-header modal-header">
                       <h4><i class="fa fa-bars"></i> Job Grade</h4>
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/jobgrade'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="jobgrade_name" v-model="form_data.jobgrade_name" name="jobgrade_name" placeholder="Enter Job Grade" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <textarea v-model="form_data.leave_note" id="leave_note" name="leave_note" placeholder="Enter Remarks" class="form-control" type="text"></textarea>
                                     </div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-md-12 control-label">Insurance Amount</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input v-model="form_data.insurance_amount" placeholder="Insurance Amount" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <label class="col-md-6 control-label">Yearly Premium Cost</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input v-model="form_data.yearly_premium_cost" placeholder="Yearly Premium Cost" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="sbu_name" v-model="form_data.priority" placeholder="Enter Priority" class="form-control" type="number"></div>
                                 </div>
                              </div>
