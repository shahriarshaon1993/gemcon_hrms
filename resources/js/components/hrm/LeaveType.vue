                ...
                <div class="card-header">
                   <div class="row">
                       <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                           <h3 class="card-title d-none d-md-block"> Leave Type</h3>
                ...
                <div class="col-md-6 col-sm-6 col-6 float-left" style="padding:0px;">
                  ...
                  <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                    ...
                    <tr>
                      ...
                      <th class="text-center" v-bind:class="getSortingClass('leave_type_name')" @click="sortingChanged('leave_type_name')">Type Name <i class="fas fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('priority')" @click="sortingChanged('priority')">Short Name<i class="fas fa-sort"></i></th>
                      ...
                      <th class="text-center" v-bind:class="getSortingClass('leave_type_status')" @click="sortingChanged('leave_type_status')">Leave Status <i class="fas fa-sort"></i></th>
                    ...
                    <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-center">{{form_data.leave_short_type}}</td>
                        <td class="text-center">{{form_data.priority}}</td>
                        <td class="text-center" v-if="form_data.leave_type_status==1">{{'Active'}}</td>
                        <td class="text-center" v-else>{{'Inactive'}}</td>
                        <td class="text-center">
                          <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/leavetype/'+form_data.id})" class="btn-xs btn-info" title="Edit" > <i class="fa fa-edit"> </i> </button>
                          <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/leavetype/'+form_data.id})" title="Delete" class="btn-xs btn-danger" ><i class="fa fa-trash"></i> </button>
                        </td>
                    </tr>
                    </tbody>
                     <tbody v-else>
      ...
      <modal name="myModal" width="400" height="auto"  :clickToClose="false"> 
            <div v-if="modal_loading">
                <div class="widget-header modal-header">
                    <h4><i class="fa fa-bars"></i> Leave Type</h4>
                ...
                <div class="modify-wraper modal-body">
                  <div class="">
                       <form @submit.prevent="add({add:'add/leavetype'},resetModal)" class="well form-horizontal needs-validation" novalidate>
                          ...
                          <div class="col-md-12">
                            <div v-if="errors" class="alert alert-danger" style="">
                             ...
                             <div class="form-group">
                                <label class="col-md-12 control-label">Leave Type Name</label>
                                <div class="col-md-12 inputGroupContainer">
                                   <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                    <input v-model="form_data.leave_type_name" id="leave_days" name="leave_days" placeholder="" class="form-control" required="true" type="text">
                                  </div>
                                </div>
                             </div>
                             <div class="form-group">
                                <label class="col-md-12 control-label">Short Name</label>
                                <div class="col-md-12 inputGroupContainer">
                                   <div class="input-group">
                                      <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                      <select class="form-control" v-model="form_data.leave_short_type" required="true">
                             ...
                             <div class="form-group" v-if="form_data.id">
                                ...
                                <div class="col-md-12 inputGroupContainer">
                                   <div class="input-group">
                                      <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                      <select class="form-control" v-model="form_data.leave_type_status" required="true">
                                         <option disabled>--Select--</option>
