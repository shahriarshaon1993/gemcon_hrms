  ...
  <div>
    <div v-if="page_loading" class="widget box">
      <div class="widget-header">
                      ...
                      >
                        ...
                        <span class="float-sm-right" style="float: right">
                          ...
                          <div
                            ...
                            class="btn-group"
                          >
                            <span class="btn btn-sm btn-succeess"
                              ><i class="icon-plus"></i>Multi Add</span
                            >
                          </div>
                        ...
                        <!-- v-if="lists.multi_add == 'multi_add'" -->
                      </div>
                    </div>
                    <div class="row">
                      ...
                      >
                        <thead>
                          <tr>
                            ...
                            <th
                              class="text-center"
                              v-bind:class="
                                getSortingClass('manual_attendance_date')
                              "
                              @click="sortingChanged('manual_attendance_date')"
                            >
                            ...
                            <th
                              class="text-center"
                              v-bind:class="
                                getSortingClass('manual_attendance_issues')
                              "
                              @click="sortingChanged('manual_attendance_issues')"
                            >
                              Attendance Issue <i class="fas fa-sort"></i>
                            </th>
                            <th
                              class="text-center"
                              v-bind:class="getSortingClass('manual_start_time')"
                              @click="sortingChanged('manual_start_time')"
                            >
                            ...
                            <th
                              class="text-center"
                              v-bind:class="
                                getSortingClass('attendance_type')
                              "
                              @click="sortingChanged('attendance_type')"
                            >
                              Attendance type <i class="fas fa-sort"></i>
                            </th>
                            <th
                              class="text-center"
                              v-bind:class="
                                getSortingClass('manual_attendance_status')
                              "
                              @click="sortingChanged('manual_attendance_status')"
                            >
                        ...
                        <tbody v-if="Object.keys(paginate_data.data).length > 0">
                          ...
                          >
                            ...
                            <td class="text-center">
                              {{ form_data.manual_attendance_date }}
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-left">
                              {{ form_data.attendance_issue }}
                            </td>

                            <td class="text-center">
                              {{
                                form_data.manual_start_time +
                                "-" +
                                form_data.manual_end_time
                              }}
                            </td>
                            <td class="text-left">
                              {{
                                form_data.attendance_type == 1
                                  ? "Manual Attendance"
                                  : "Manual Absent"
                              }}
                            </td>
                            <td class="text-center">
                              <span
                                v-if="form_data.manual_atten_approve_status == 1"
                              >
                                Requested</span
                              >
                              <span
                                v-else-if="
                                  form_data.manual_atten_approve_status == 2
                                "
                              >
                                Approved</span
                              >
                              <span
                                v-else-if="
                                  form_data.manual_atten_approve_status == 3
                                "
                              >
                                Forwarded</span
                              >
                              <span
                                v-else-if="
                                  form_data.manual_atten_approve_status == 4
                                "
                              >
                                Rejected</span
                              >
                            ...
                            <td class="text-center">
                              <!-- <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/manualattendance/'+form_data.id},setModalData)" class="btn-xs btn-info" title="Edit" > <i class="fa fa-edit"> </i> </button>
                            <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/manualattendance/'+form_data.id})" title="Delete" class="btn-xs btn-danger" ><i class="fa fa-trash"></i> </button> -->
                              ...
                              <button
                                @click="
                                  getModalData(
                                    ...
                                    {
                                      dataUrl:
                                        'edit/manualattendance/' + form_data.id,
                                    },
                                    setModalData,
                                    (add_new_type = 3)
                                  )
                              ...
                              >
                                <button
                                  ...
                                  @click="
                                    deleteItem({
                                      delUrl:
                                        'delete/manualattendance/' + form_data.id,
                                    })
                                  "
                                  title="Delete"
                              ...
                              <span
                                v-if="form_data.manual_atten_approve_status == 2"
                              >
                                <button
                                  v-if="lists.hard_cancel == 'hard_cancel'"
                                  @click="
                                    deleteItem({
                                      delUrl:
                                        'hard_delete/manualattendance/' + form_data.id,
                                    })
                                  "
                                  title="Delete"
        ...
        <modal class="manual-attendance-mobile" name="myModal" width="550" height="auto" :clickToClose="false">
          <div v-if="modal_loading">
            <div class="widget-header modal-header">
              <h4 v-if="add_new_type == 1 || add_new_type == 2">
                <i class="fa fa-bars"></i> Manual Attendance
              </h4>
              <h4 v-if="add_new_type == 4">
                <i class="fa fa-bars"></i> Multi Manual Attendance
              </h4>
              <h4 v-if="add_new_type == 3">
                <i class="fa fa-bars"></i> Manual Attendance Approval
              </h4>
              <button
                type="button"
                @click="hideModal"
            ...
            <div class="modify-wraper modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            ...
                            ></span>
                            <vue-select
                              v-model="attendance_issues_name_value"
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            <span
                              ...
                              ><i class="glyphicon glyphicon-list"></i
                            ></span>
                            <input class="form-control" v-model="form_data.manual_attendance_date" type="date" @click="dateChange($event.target)"  v-on:input="dateChange($event.target)" v-on:keyup="dateChange($event.target)">
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            ...
                            ></span>
                            <select
                              v-model="form_data.attendance_type"
                              class="form-control"
                              required
                            >
                              <option selected>Select one</option>
                              <option value="1">Manual Attendance</option>
                              <option value="2">Manual Absent</option>
                            </select>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            ...
                            <vue-timepicker
                              class="form-control"
                              v-model="form_data.manual_start_time"
                              required
                            ></vue-timepicker>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            ...
                            <vue-timepicker
                              class="form-control"
                              v-model="form_data.manual_end_time"
                              required
                            ></vue-timepicker>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group">
                            ...
                            ></span>
                            <textarea
                              v-model="form_data.manual_remarks"
                              id="leave_note"
                              name="leave_note"
                              placeholder=""
                              class="form-control"
              ...
              <span v-if="add_new_type == 4">
                <div class="">
                  <form
                    @submit.prevent="
                      add({ add: 'multi_add/manualattendance' }, resetModal)
                    "
                    class="well form-horizontal needs-validation"
                    novalidate
                  >
                    <div class="col-md-12 date_format_modal_design">
                      ...
                      <div class="form-group">
                        ...
                        >
                        <div class="col-md-12 inputGroupContainer">
                          <div class="input-group col-md-6 float-left" style="padding-left:0px;">
                            <span
                              class="input-group-addon"
                              style="max-width: 100%"
                              ><i class="glyphicon glyphicon-list"></i
                          ...
                          <div class="input-group col-md-6 float-left" style="padding-left:0px;">
                            <span
                              ...
                              ><i class="glyphicon glyphicon-list"></i
                            ></span>
                            <input class="form-control" v-model="form_data.manual_attendance_date_to" type="date" @click="dateChange($event.target)"  v-on:input="dateChange($event.target)" v-on:keyup="dateChange($event.target)">
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div class="col-md-12">
                      <div class="col-md-12">
                          ...
                          <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                              ...
                              <datepicker
                                ...
                                v-model="form_data.manual_attendance_date"
                                class="form-control"
                                disabled
                        ...
                        <span v-if="form_data.manual_atten_approve_status != 4">
                          <span
                            v-if="form_data.manual_atten_approve_status != 2"
                          >
                            <div class="form-group">
                            ...
                            <div class="form-actions col-md-12 manual-attendance-footer">
                              <button
                                type="button"
                                @click="
                                  add(
                                    { add: 'approveOrReject/manualattendance' },
...
export default {
  ...
  methods: {
    ...
    onSelectEmployee(option) {
      this.today_date = this.form_data.manual_attendance_date;
      ...
      axios
        ...
        .then((res) => {
          console.log(res);
          this.form_data.manual_start_time  = res.data.manual_start_time;
          this.form_data.manual_end_time = res.data.manual_end_time;
        })
        .catch((error) => {
          this.form_data.manual_start_time = '00:00';
          this.form_data.manual_end_time = '00:00';
          // this.modal_loading = true;
        });
      

      // let shift_time_data=Object.values(this.form_data.shift_time_datas);
      // let single_employee =[...new Map((shift_time_data.filter(obj => obj.employee_id ==  this.form_data.employee_id && obj.start_date <= this.today_date && obj.end_date >= this.today_date)).map((item) => [item["id"], item])).values()]
      // console.log(single_employee[0]);
      // if(single_employee.length > 0){
      //   this.form_data.manual_start_time = single_employee[0].office_start_time;
      //   this.form_data.manual_end_time = single_employee[0].office_end_time;
      //   console.log(this.form_data.manual_start_time);
      // }else{
      //   this.form_data.manual_start_time = '00:00';
      //   this.form_data.manual_end_time = '00:00';
      // }
    ...
    dateChange: function (target) {
      ...
      // console.log(this.employee_primary_id);
      // console.log(this.today_date);
     // let shift_time_data=Object.values(this.form_data.shift_time_datas);
      //let single_employee =[...new Map((shift_time_data.filter(obj => obj.employee_id ==  this.form_data.employee_id && obj.start_date <= this.today_date && obj.end_date >= this.today_date)).map((item) => [item["id"], item])).values()]
      // console.log(single_employee.length);
      // if(single_employee.length > 0){
      //   this.form_data.manual_start_time = single_employee[0].office_start_time;
      //   this.form_data.manual_end_time = single_employee[0].office_end_time;
      //    console.log(this.form_data.manual_start_time);
    ...
    setModalData() {
      ...
      this.attendance_issues_name_value =
        this.form_data.attendance_issues_name_value;
      this.attendance_type = this.form_data.attendance_type;
    },
    resetModal() {
