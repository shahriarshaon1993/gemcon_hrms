                ...
                <div class="card-header">
                   <div class="row">
                       <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                           <h3 class="card-title d-none d-md-block">Roaster Setup</h3>
                ...
                <div class="card-body col-md-12">
                  ...
                  <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                    ...
                    <tr>
                      ...
                      <th class="text-center" v-bind:class="getSortingClass('office_time_start_date')" @click="sortingChanged('office_time_start_date')">Roaster Title<i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_time_start_date')" @click="sortingChanged('office_time_start_date')">Roaster Start Date <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_time_end_date')" @click="sortingChanged('office_time_end_date')">Roaster End Date <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_start_time')" @click="sortingChanged('office_start_time')">Roaster Start Time <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_end_time')" @click="sortingChanged('office_end_time')">Roaster End Time <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_time_status')" @click="sortingChanged('office_time_status')">Roaster Note <i class="fa fa-sort"></i></th>
                    ...
                    <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-center">{{form_data.title}}</td>
                        ...
                        <td class="text-center">
                          <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/roaster_setup/'+form_data.id})" class="btn btn-info btn-xs" title="Edit"> <i class="fa fa-edit"> </i> Edit </button>
                          <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/roaster_setup/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</button>
                        </td>
                    </tr>
                    </tbody>
                     <tbody v-else>
       ...
       <modal ref="modal" class=""  width="400" name="myModal" height="auto" :clickToClose="false" body-class="p-0">
            <div v-if="modal_loading">
                <div class="widget-header modal-header">
                    <h4><i class="icon-reorder"></i>Shift Time Setup</h4>
                ...
                <div class="modify-wraper modal-body">
                  ...
                  <div class="">
                     <form @submit.prevent="add({add:'add/roaster_setup'},resetModal)" class="well form-horizontal needs-validation" novalidate>
                      <div class="row" style="margin:0px">
                        <div class="col-md-12">
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster Title</label>
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster Start Date</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster End Date</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster Start Time</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster End Time</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                           ...
                           <div class="form-group">
                              <label class="col-md-4 control-label">Roaster Note</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Roaster Status</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
