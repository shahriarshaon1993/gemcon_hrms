              ...
              <div class="card">
                <div class="card-header">
                   <div class="row">
                       <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                           <h3 class="card-title d-none d-md-block">Shift Time Setup</h3>
                ...
                <div class="card-body col-md-12">
                  ...
                  <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                    <thead>
                    <tr>
                      <th class="text-center" v-bind:class="getSortingClass('id')" @click="sortingChanged('id')">SL<i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_time_start_date')" @click="sortingChanged('office_time_start_date')">Title<i class="fa fa-sort"></i></th>
                      <!-- <th class="text-center" v-bind:class="getSortingClass('office_time_start_date')" @click="sortingChanged('office_time_start_date')">Start Date <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_time_end_date')" @click="sortingChanged('office_time_end_date')">End Date <i class="fa fa-sort"></i></th> -->
                      <th class="text-center" v-bind:class="getSortingClass('office_start_time')" @click="sortingChanged('office_start_time')">Start Time <i class="fa fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('office_end_time')" @click="sortingChanged('office_end_time')">End Time <i class="fa fa-sort"></i></th>
                    ...
                    <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td style="color:green;" class="text-center" v-if="form_data.office_time_status==1">{{'Active'}}</td>
                        <td style="color:red;" class="text-center" v-else>{{'Inactive'}}</td>
                        <td class="text-center">
                          <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/shift_time/'+form_data.id})" class="btn btn-info btn-xs" title="Edit"> <i class="fa fa-edit"> </i> Edit </button>
                          <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/shift_time/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</button>
                        </td>
                    </tr>
                    </tbody>
                     <tbody v-else>
       ...
       <modal ref="modal" class=""  width="400" name="myModal" height="auto" :clickToClose="false" body-class="p-0">
            <div v-if="modal_loading">
                ...
                <div class="modify-wraper modal-body">
                  ...
                  <div class="">
                     <form @submit.prevent="add({add:'add/shift_time'},resetModal)" class="well form-horizontal needs-validation" novalidate>
                      <div class="row" style="margin:0px">
                        <div class="col-md-12">
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Shift Type</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
