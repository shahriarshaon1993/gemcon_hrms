                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Sub Section List</h3>
                               <span class="float-sm-right" style="float: right;">
                                 <!-- <a class="btn btn-info" href="#" data-toggle="modal" data-target="#addNewDesingation"><i class="fa fa-plus"></i> Add New</a> -->
                                 <div  v-if="lists.add=='add'" @click="getModalData($event,{dataUrl:'create/sub_section'})" class="btn-group"> <span class="btn btn-sm btn-info"><i class="icon-plus"></i>Add New</span></div>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('sub_section_code')" @click="sortingChanged('sub_section_code')">Sub Section Code <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('sub_section_name')" @click="sortingChanged('sub_section_name')">Sub Section Name <i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('sub_section_status')" @click="sortingChanged('sub_section_status')">Sub Section Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i = index>
                            ...
                            <td class="text-center">{{form_data.sub_section_code}}</td>
                            <td>{{form_data.sub_section_name}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center" v-if="form_data.sub_section_status==1">{{'Active'}}</td>
                            <td class="text-center" v-else>{{'Inactive'}}</td>
                            <td class="text-center">
                              <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/sub_section/'+form_data.id})" class="btn btn-info btn-xs" title="Edit" > <i class="fa fa-edit"> </i> Edit </button>
                            
                              <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/sub_section/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
          ...
          <modal class="" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   <div class="widget-header modal-header">
                       <h4><i class="fa fa-bars"></i> Sub Section</h4>
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/sub_section'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="">
                           <div class="col-md-12">
                              
                              <div class="form-group">
                                 <label class="col-md-6 control-label">Sub Section Name</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="sub_section_name" v-model="form_data.sub_section_name" name="sub_section_name" placeholder="" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group" v-if="form_data.id">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class="form-control" v-model="form_data.sub_section_status" required="true">
...
<script>
    ...
    export default {
        ...
        methods:{
          resetModal(){
            this.form_data.sub_section_status='1';
          },
        }
