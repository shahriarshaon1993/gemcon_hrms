                ...
                <div class="dropdown-menu dropdown-menu-right pb-0">
                  <a class="dropdown-item" href="">
                    ...
                    <router-link :to="{ path: '/profile' }">
                      <i class="bx bx-add-alt"></i> Profile
                    </router-link>
                  </a>
          ...
          <li class="nav-item mr-auto">
            <a class="navbar-brand" href="../">
              <div class="brand-logo">
                <img
                  class="logo"
                  :src="api_url + 'admin_assets/images/gemcon-logo.png'"
                />
              </div>
            </a>
          </li>
        ...
        >
          ...
          <li class="nav-item">
            <a href="#" class="icon_right"
              ...
              ><span class="menu-title" data-i18n="Content">Entry</span>
          ...
          <li class="nav-item">
                <router-link :to="{ path: '/department_setting' }">
                  <i class="bx bx-right-arrow-alt"></i
                  ><span class="menu-item" data-i18n="Analytics"
                    >Department month open</span
                  >
                </router-link>
              </li>
          <!-- <li class="nav-item">
            <a href="#" class="icon_right"
              ><i class="bx bxl-redux"></i
              ><span class="menu-title" data-i18n="Content">JD setup</span>
              <i class="bx bx-chevron-down"></i
            ></a>

            <ul class="menu-content">
              <li class="nav-item">
                <router-link :to="{ path: '/assessment_qus' }">
                  <i class="bx bx-right-arrow-alt"></i
                  ><span class="menu-item" data-i18n="Analytics">
                    JD setup
                  </span>
              ...
              <li class="nav-item">
                <router-link :to="{ path: '/assessment_list' }">
                  <i class="bx bx-right-arrow-alt"></i
                  ><span class="menu-item" data-i18n="Analytics"
                    >JD list
                  </span>
          ...
          <li class="nav-item">
            <router-link :to="{ path: '/bpt_report' }">
              ...
              ><span class="menu-item" data-i18n="Analytics">BPT Report</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ path: '/assessment_list' }">
              <i class="bx bx-bar-chart"></i
              ><span class="menu-item" data-i18n="Analytics">JD list</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ path: '/assessment_user_list' }">
              <i class="bx bx-bar-chart"></i
              ><span class="menu-item" data-i18n="Analytics">Evaluate</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ path: '/evaluation_list' }">
              <i class="bx bx-bar-chart"></i
              ><span class="menu-item" data-i18n="Analytics">Evaluate List</span>
            </router-link>
          </li>
        </ul>
      </div>
          ...
          .then(
            (res) => {
              if (res.data.status == 1) {
                ...
                this.$localStorage.set("user", JSON.stringify(res));
              }
              if (res.error) {
                this.$localStorage.remove("user");
              }
