    ...
    <div v-if="page_loading" class="widget box">
        <div class="widget-header">
            ...
            <div class="toolbar no-padding ">
                <div v-if="lists.add=='add'" @click="getModalData($event, {dataUrl:'salesPerson/create'})" class="btn-group"> <span class="btn btn-xs btn-info"><i class="icon-plus"></i>Add New</span></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 paddingZero">
                                            ...
                                            <div class="col-md-12 city-field">
                                                <textarea v-model="form_data.comments" style="width: 586px;height: 53px;border: 1px solid #4d7496" type="text" class="form-control required textarea-height-set" placeholder="Comments"></textarea>
                                            </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody v-if="Object.keys(paginate_data.data).length > 0">
                        <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id">
                            ...
                            <td class="action">
                                <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'salesPerson/edit/'+form_data.id})" class="btn-xs btn-info" title="Edit" data-toggle="modal" data-target="#myModal"><i class="icon-edit"></i> </button>
                                <button v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'salesPerson/delete/'+form_data.id})" title="Delete" class="btn-xs btn-danger"><i class="icon-trash"></i> </button>
                            </td>
                        </tr>
                    </tbody>
                    <tbody v-else>
