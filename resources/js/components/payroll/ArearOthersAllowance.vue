                ...
                <div class="card">
                        ...
                        <span class="float-sm-right" style="float: right">
                          <div
                            @click="
                              getModalData(
                                $event,
                                { dataUrl: 'create/arrear_others_allowance' },
                                resetModal,
                                (type = 1)
                              )
                            "
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-12 col-md-3">
                        <div class="info-box">
                          ...
                          ></span>
                          <div class="info-box-content">
                            <span class="info-box-text">Arrear Amount </span>
                            <span class="info-box-number">
                              {{ lists.total_arrear }}
                            </span>
                          </div>
                      ...
                      <div class="col-12 col-sm-12 col-md-3">
                        <div class="info-box mb-3">
                          ...
                          ></span>
                          <div class="info-box-content">
                            <span class="info-box-text">Others Amount </span>
                            <span class="info-box-number">
                              {{ lists.total_others }}
                            </span>
                          </div>
                      ...
                      <div class="col-12 col-sm-12 col-md-3">
                        <div class="info-box mb-3">
                          ...
                          <div class="info-box-content">
                            ...
                            <span class="info-box-number">{{
                              lists.total_arrear + lists.total_others
                            }}</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-body col-md-12">
                    ...
                    >
                      ...
                      <div class="button_group">
                        <a
                          :href="'payroll/arrear_others_allowance/filedownload'"
                          class="
                            button_s
                            my_file
                            el-button
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th class="text-center">Allowances On</th>
                      ...
                      <tbody v-if="Object.keys(paginate_data.data).length > 0">
                        ...
                        >
                          ...
                          <td class="text-center">
                            <span
                              v-if="form_data.additional_allow_type == 1"
                              style="color: green"
                              >Arrear</span
                            >
                            <span
                              v-if="form_data.additional_allow_type == 2"
                              style="color: green"
                              >Bonus</span
                            >
                          </td>
                          ...
                          <td class="text-right">
                            {{ form_data.additional_amount | number("0,0.00") }}
                          </td>
                          <td class="text-center">
                            <span
                              v-if="form_data.additional_status == 1"
                              style="color: green"
                              >Active</span
                            >
                          ...
                          <td class="text-center" style="width: 18%">
                            ...
                            <button
                              ...
                              @click="
                                deleteItem({
                                  delUrl:
                                    'delete/arrear_others_allowance/' +
                                    form_data.id,
                                })
                              "
                              title="Delete"
          ...
          <div v-if="modal_loading">
            <span v-if="type == 1">
              <div class="widget-header modal-header">
                <h4><i class="fa fa-bars"></i> Additional Bill</h4>
                <button
                  type="button"
                  @click="hideModal"
              ...
              <div class="modify-wraper modal-body">
                <div class="container">
                  <form
                    @submit.prevent="
                      add({ add: 'add/arrear_others_allowance' }, resetModal)
                    "
                        ...
                        >
                          ...
                          >
                            ...
                            <div
                              ...
                              v-if="form_data.user_employee_data"
                            >
                              <span
                                v-if="
                              ...
                              <div class="col-md-12 inputGroupContainer">
                                <div class="input-group">
                                  ...
                                  <select
                                    ...
                                    class="form-control"
                                    v-model="form_data.additional_allow_type"
                                    required="true"
                                  >
                                    ...
                                    <option value="3">Additional Allownce</option>
                                    <option value="4">Incentive</option>
                              ...
                              <div class="col-md-12 inputGroupContainer">
                                <div class="input-group">
                                  ...
                                  <input
                                    ...
                                    v-model="form_data.additional_date"
                                    class="form-control"
                                    value=""
                                    min="1997-01-01"
                                    max="2030-12-31"
                                  />
                                  <!-- <input type="date" name="bday"  style="width: 131% !important;" v-model="form_data.additional_date" class="form-control" required pattern="\d{4}-\d{2}-\d{2}"> -->
                                  <!-- <input type="date" style="width: 131% !important;" v-model="form_data.additional_date" class="form-control" > -->
                                  <!-- <datepicker placeholder="Select Date"  style="width: 131% !important;" v-model="form_data.additional_date" class="form-control" ></datepicker> -->
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-12 inputGroupContainer">
                                <div class="input-group">
                                  ...
                                  <input
                                    id="department_name"
                                    v-model="form_data.additional_amount"
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-12 inputGroupContainer">
                                <div class="input-group">
                                  ...
                                  <input
                                    id="department_name"
                                    v-model="form_data.additional_remarks"
                                    name="department_name"
                                    placeholder=""
                                    class="form-control"
                                    type="text"
                        ...
                        <div class="form-group" v-if="form_data.id">
                          ...
                          <div class="col-md-12 inputGroupContainer">
                            <div class="input-group">
                              ...
                              <select
                                class="form-control"
                                v-model="form_data.additional_status"
                                required="true"
                              >
              ...
              <div class="modal-body">
                <div class="row" v-if="profile_open == 1">
                  <div class="col-md-12">
                    ...
                    <div
                      class="col-md-3 float-left text-center"
                      v-if="form_data.user_employee_data"
                    >
...
export default {
  ...
  methods: {
    ...
    excelFileUpload(excellist) {
      ...
      let uri = URL.baseUrl("excel/arrear_others_allowance");
      axios
        .post(uri, {
          form_data: excellist,
        })
