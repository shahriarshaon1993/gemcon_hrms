                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Grade List</h3>
                               <span class="float-sm-right" style="float: right;">
                                 <div v-if="lists.add=='add'" @click="getModalData($event,{dataUrl:'create/grade_setting/'},resetModal)" class="btn-group"> <span class="btn btn-sm btn-info"><i class="icon-plus"></i>Add New</span></div>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('grade_code')" @click="sortingChanged('grade_code')">Grade Code <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('product_name')" @click="sortingChanged('product_name')">Product Name <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('grade_name')" @click="sortingChanged('grade_name')">Grade <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('product_rate')" @click="sortingChanged('product_rate')">Rate <i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('grade_status')" @click="sortingChanged('grade_status')">Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                            ...
                            <td class="text-center">{{form_data.grade_code}}</td>
                            <td class="text-left">{{form_data.product_name}}</td>
                            <td class="text-left">{{form_data.grade_name}}</td>
                            <td class="text-right">{{form_data.product_rate}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center">
                              <span v-if="form_data.grade_status==1" style="color:green;">
                                {{"Active"}}
                              </span>
                            ...
                            <td class="text-center">
                              <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/grade_setting/'+form_data.id},setModalData)" class="btn btn-info btn-xs" title="Edit" data-toggle="modal" data-target="#addNewJobGrade" > <i class="fa fa-edit"> </i> Edit </button>
                              <button v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/grade_setting/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
                               </td>
                          </tr>
                        </tbody>
                         <tbody v-else>
          ...
          <modal class="" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   <div class="widget-header modal-header">
                       <h4><i class="fa fa-bars"></i> Product Grade</h4>
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/grade_setting'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 inputGroupContainer">
                                            <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                              <vue-select v-model="product_name_value" :options="option_data.company_product_data" @select="ComapnyProductData" placeholder="Select one" label="text" track-by="text"></vue-select>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 inputGroupContainer">
                                            <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                            <input id="grade_name" v-model="form_data.grade_name" name="grade_name" placeholder="" class="form-control" required="true" type="text"></div>
                                        </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 inputGroupContainer">
                                            <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                            <input id="grade_name" v-model="form_data.product_rate" name="grade_name" placeholder="" class="form-control" required="true" type="text"></div>
                                        </div>
                                    </div>
                                     <div class="col-md-6">
                              ...
                              <div class="form-group" v-if="form_data.id">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class="form-control" v-model="form_data.grade_status" required="true">
...
<script>
  ...
  export default {
      ...
      methods:{
        ...
        ComapnyProductData(option){
          console.log(option);
          this.form_data.product_id= option.id;
        },
        setModalData(){
            this.sbu_name_value=this.form_data.sbu_name_value;
            this.product_name_value=this.form_data.product_name_value;
        },
        resetModal(){
            this.sbu_name_value='';
            this.product_name_value='';
        },
      }
  }
</script>