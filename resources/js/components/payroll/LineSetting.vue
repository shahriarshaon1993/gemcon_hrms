                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Line List</h3>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('line_code')" @click="sortingChanged('line_code')">Line Code <i class="fas fa-sort"></i></th>
                            <th class="text-center" v-bind:class="getSortingClass('line_name')" @click="sortingChanged('line_name')">Line Name <i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('line_status')" @click="sortingChanged('line_status')">Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                            ...
                            <td class="text-center">{{form_data.line_code}}</td>
                            <td class="text-left">{{form_data.line_name}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center">
                              <span v-if="form_data.line_status==1" style="color:green;">
                                {{"Active"}}
                              </span>
                            ...
                            <td class="text-center">
                              <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/line_setting/'+form_data.id},setModalData)" class="btn btn-info btn-xs" title="Edit" data-toggle="modal" data-target="#addNewJobGrade" > <i class="fa fa-edit"> </i> Edit </button>
                              <button v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/line_setting/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
                               </td>
                          </tr>
                        </tbody>
                         <tbody v-else>
          ...
          <modal class="" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   <div class="widget-header modal-header">
                       <h4><i class="fa fa-bars"></i>Production Line</h4>
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/line_setting'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="">
                           <div class="col-md-12">
                              ...
                              <div class="form-group">
                                 <label class="col-md-6 control-label">Line Name</label>
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="line_name" v-model="form_data.line_name" name="line_name" placeholder="" class="form-control" required="true" type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group" v-if="form_data.id">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class="form-control" v-model="form_data.line_status" required="true">
