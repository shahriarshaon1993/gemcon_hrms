                    ...
                    <thead>
                     ...
                     <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-center">{{form_data.remarks}}</td>
                        ...
                        <td class="text-center" style="width: 25%;">
                          ...
                          <router-link href="#" :to="'/payroll_list_details/'+form_data.id" class="btn btn-xs btn-success" title="Add More Data">
                            <i class="fa fa-search" aria-hidden="true"></i> Details
                          </router-link>
                          
                          <button v-if="form_data.settlement==1" class="btn btn-xs btn-info" @click="getModalData($event,{dataUrl:'final_process/payroll_list/'+form_data.id})" title="Edit" > <i class="fa fa-tasks"> </i> Final Process </button>
                          <button v-if="form_data.settlement==2" class="btn btn-xs btn-info" title="Final Process Completed!" @click="AccessDenied($event,value=' Final Process Completed!')" style="opacity: 0.5"> <i class="fa fa-tasks"> </i> Final Process </button>
                           ...
                           <button  v-if="form_data.settlement==1" class="btn btn-xs btn-danger"  @click="deleteItem({delUrl:'delete/payroll_list/'+form_data.id})" title="Delete" ><i class="fa fa-trash"></i> Delete</button>
