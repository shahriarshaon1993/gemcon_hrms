                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">Product List</h3>
                      ...
                      <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('project_code')" @click="sortingChanged('project_code')">Product Code <i class="fas fa-sort"></i></th>
                            ...
                            <th class="text-center" v-bind:class="getSortingClass('product_status')" @click="sortingChanged('product_status')">Status <i class="fas fa-sort"></i></th>
                         ...
                         <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                          <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                            ...
                            <td class="text-center">{{form_data.product_code}}</td>
                            <td class="text-left">{{form_data.product_name}}</td>
                            <td class="text-center">{{form_data.priority}}</td>
                            <td class="text-center">
                              <span v-if="form_data.product_status==1" style="color:green;">
                                {{"Active"}}
                              </span>
                            ...
                            <td class="text-center">
                              <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/product_setting/'+form_data.id},setModalData)" class="btn btn-info btn-xs" title="Edit" data-toggle="modal" data-target="#addNewJobGrade" > <i class="fa fa-edit"> </i> Edit </button>
                              <button v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/product_setting/'+form_data.id})" title="Delete" class="btn btn-danger btn-xs" ><i class="fa fa-trash"></i> Delete</button>
                               </td>
                          </tr>
                        </tbody>
                         <tbody v-else>
          ...
          <modal class="" name="myModal" height="auto" :clickToClose="false">
               <div v-if="modal_loading">
                   ...
                   <div class="modify-wraper modal-body">
                       <form @submit.prevent="add({add:'add/product_setting'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                         <div class="">
                           <div class="col-md-12">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                     <input id="product_name" v-model="form_data.product_name" name="product_name" placeholder="" class="form-control" required="true"  type="text"></div>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group" v-if="form_data.id">
                                 ...
                                 <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                       ...
                                       <select class="form-control" v-model="form_data.product_status" required="true">
