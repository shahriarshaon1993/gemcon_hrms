                    ...
                    <div class="card-header">
                       <div class="row">
                           <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                               <h3 class="card-title d-none d-md-block">SIM Assign List</h3>
                           ...
                           <div class="col-12 col-sm-12 col-md-3">
                             <div class="info-box mb-3">
                               ...
                               <div class="info-box-content">
                                 ...
                                 <span class="info-box-number">{{lists.total_amount}}</span>
                               </div>
                             </div>
                           </div>
                       </div>
                    ...
                    <thead>
                     ...
                     <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-left">{{form_data.sim_number}}</td>
                        <td class="text-left">{{form_data.sim_assign_date}}</td>
                        <td class="text-left">{{form_data.inactive_date}}</td>
                        <td class="text-right">{{form_data.sim_ceiling_limit |number('0,0.00')}}</td>
                        <td class="text-center">
                          <span v-if="form_data.sim_assign_status==1" style="color:green;">Active</span>
                          <span v-else style="color:red;">Inactive</span>
                        </td>
                        <td class="text-center">
                          <button class="btn btn-xs btn-info" @click="getModalData($event,{dataUrl:'edit/sim_allocation/'+form_data.id}, setModalData, type=1)" title="Edit" > <i class="fa fa-edit"> </i> Edit </button>             
                          <!-- <button class="btn btn-xs btn-danger"  @click="deleteItem({delUrl:'delete/sim_allocation/'+form_data.id})" title="Delete" ><i class="fa fa-trash"></i> Delete</button> -->
                        </td>
                      </tr>
                    </tbody>
                     <tbody v-else>
            ...
            <div v-if="modal_loading">
              <!-- <span v-if="type==1"> -->
                  <div class="widget-header modal-header">
                      <h4><i class="fa fa-bars"></i> SIM Assign</h4>
                  ...
                  <div class="modify-wraper modal-body">
                    <div class="container">
                      <form @submit.prevent="add({add:'add/sim_allocation'},resetModal)" class="form-horizontal  row-border" id="validate-1">
                        <div class="row">
                          <div class="col-md-12">
                              <div class="form-group" v-if="!form_data.id">
                                ...
                                <div class="row" v-if="profile_open==1" style="margin-bottom: 10px;margin-right: -1.5px; margin-top: 10px;">
                              ...
                              <div class="row" style="margin-top: 47px;">
                               <div class="col-md-4">
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12 inputGroupContainer">
                                       <div class="input-group">
                                          <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                          <vue-select required="true" v-model="sim_number_value" :options="option_data.sim_number_data" @select="onSelectNumberSearch" placeholder="Select one"  label="text" track-by="text"></vue-select>
                                       </div>
                                    </div>
                                 </div>
                               </div>
                               <div class="col-md-4">
                                 <div class="form-group">
                                    <label class="col-md-12 control-label">Assigning Date <sup style="color: red; top: -2px;">*</sup></label>
                                    <div class="col-md-12 inputGroupContainer">
                                       <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                        <datepicker placeholder="Select Date" style="width: 131% !important;" v-model="form_data.sim_assign_date" class="form-control" ></datepicker>
                                     </div>
                                    </div>
                                 </div>
                               </div>
                               <!-- </div> -->
                                ...
                                <div class="col-md-4"> 
                                  <div class="form-group">
                                     <label class="col-md-12 control-label">Ceiling Amount</label>
                                     <div class="col-md-12 inputGroupContainer">
                                        <div class="input-group">
                                         <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                         <input id="department_name" v-model="form_data.sim_ceiling_limit" name="department_name" placeholder="" required="true" class="form-control" type="number" step="0.01">
                                       </div>
                                     </div>
                                  </div>
                                </div>
                                ...
                                <!-- <div class="col-md-12">
                                  <div class="form-group">
                                     ...
                                     <div class="col-md-12 inputGroupContainer">
                                        <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                         <input id="department_name" v-model="form_data.sim_assign_remarks" name="department_name" placeholder="" class="form-control" type="text" step="0.01">
                                       </div>
                                     </div>
                                  </div>
                                </div> -->
                                <div class="form-group" v-if="form_data.id">
                                   ...
                                   <div class="col-md-12 inputGroupContainer">
                                      <div class="input-group">
                                         <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                         <select class="form-control" v-model="form_data.sim_assign_status" required="true">
        ...
        components:{
         ...
         methods:{
           onSelectEmployee(option){
             console.log(option);
             this.form_data.sim_assign_to= option.id;
             console.log(this.form_data.employee_id);
           },
           onSelectNumberSearch(option){
              console.log(option);
              this.form_data.sim_inventory_id= option.id;
           },
           ...
           getModalDataOther(id){
            this.modal_loading= false;
             ...
             .then(res => {
               ...
               this.form_data.sim_assign_to=id;
               this.form_data.company_sbu_id=res.data.user_employee_data.employee_sbu;
