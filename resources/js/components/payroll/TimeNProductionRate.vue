                ...
                <div class="card-header">
                   <div class="row">
                       <div class="col-12 col-sm-6 col-md-12" style="padding: 5px 10px;">
                           <h3 class="card-title d-none d-md-block">Time/Production Rate</h3>
                           <span class="float-sm-right" style="float: right;">
                             <div v-if="lists.add=='add'" @click="getModalData($event,{dataUrl:'create/time_production_rate'},resetModal)" class="btn-group"> <span class="btn btn-sm btn-info"><i class="icon-plus"></i>Add New</span> </div>
                ...
                <div class="card-body col-md-12">
                  ...
                  <table id="employeeTable" class="table table-bordered table-striped employeeTable">
                    ...
                    <tr>
                      ...
                      <th class="text-center" v-bind:class="getSortingClass('time_production_qty')" @click="sortingChanged('time_production_qty')">Rate/Production Qty <i class="fas fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('rate_type')" @click="sortingChanged('rate_type')">Rate Type <i class="fas fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('rate_amount')" @click="sortingChanged('rate_amount')">Rate/Amount <i class="fas fa-sort"></i></th>
                      <th class="text-center" v-bind:class="getSortingClass('rate_status')" @click="sortingChanged('rate_status')">Status <i class="fas fa-sort"></i></th>
                    ...
                    <tbody  v-if="Object.keys(paginate_data.data).length > 0">
                      <tr v-for="(form_data, index) in paginate_data.data" v-bind:key="form_data.id" i=index>
                        ...
                        <td class="text-center">{{form_data.time_production_qty}}</td>
                        <td class="text-center">{{form_data.rate_amount}}</td>
                        <td class="text-center" v-if="form_data.rate_status==1">{{'Active'}}</td>
                        <td class="text-center" v-else>{{'Inactive'}}</td>
                        <td class="text-center">
                          <button v-if="lists.edit=='edit'" @click="getModalData($event,{dataUrl:'edit/time_production_rate/'+form_data.id},setModalData)" class="btn-xs btn-info" title="Edit" > <i class="fa fa-edit"> </i> </button>
                          <button  v-if="lists.delete=='delete'" @click="deleteItem({delUrl:'delete/time_production_rate/'+form_data.id})" title="Delete" class="btn-xs btn-danger" ><i class="fa fa-trash"></i> </button>
                        </td>
                    </tr>
                    </tbody>
                     <tbody v-else>
      ...
      <modal name="myModal" width="550" height="auto"  :clickToClose="false"> 
            <div v-if="modal_loading">
                <div class="widget-header modal-header">
                    <h4><i class="fa fa-bars"></i> Time/Production Rate Setup</h4>
                ...
                <div class="modify-wraper modal-body">
                  <div class="container">
                     <form @submit.prevent="add({add:'add/time_production_rate'},resetModal)" class="well form-horizontal needs-validation" novalidate>
                      <div class="">
                        <div class="col-md-12">
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Rate Type</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                    <select class="form-control" v-model="form_data.rate_type" required="true">
                           ...
                           <div class="form-group">
                              <label class="col-md-6 control-label">Time/Production Qty</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                     <input  v-model="form_data.time_production_qty" class="form-control" type="number">
                                     <!-- <input  v-model="form_data.rate_amount" class="form-control" type="number"> -->
                                 </div>
                              </div>
                           </div>
                           <div class="form-group">
                              <label class="col-md-6 control-label">Rate Amount</label>
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                     <input  v-model="form_data.rate_amount" class="form-control" type="number">
                           ...
                           <div class="form-group" v-if="form_data.id">
                              ...
                              <div class="col-md-12 inputGroupContainer">
                                 <div class="input-group">
                                    <span class="input-group-addon" style="max-width: 100%;"><i class="glyphicon glyphicon-list"></i></span>
                                    <select class="form-control" v-model="form_data.rate_status" required="true">
                                       <option disabled>--Select--</option>
