...
<div id="app">
	...
	<!-- <nav class="main-header navbar navbar-expand navbar-white navbar-light"  style="background: {{$backgroundCollor}}">
	 	 <ul class="navbar-nav">
		      <li class="nav-item">
		        <a style="padding-top: 15px;" class="nav-link" data-widget="pushmenu" href="#" role="button"><i class="fas fa-bars"></i></a>
		      </li>
		    ...
		    <ul class="navbar-nav ml-auto">
			  <li class="nav-item dropdown">
			  	<a style="padding-top: 15px;" class="nav-link" href="#" data-toggle="dropdown"><i class="fas fa-th-large"></i></a>
		        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
		          ...
		          <div class="dropdown-divider"></div>
		          <a href="{{url('/dashboards_payroll')}}" class="dropdown-item" target="_blank">
		      ...
		      <li class="nav-item dropdown">
		        <a style="padding-top: 14px; font-size: 15px;" class="nav-link" data-toggle="dropdown" href="#">
		          <i class="far fa-bell"></i>
		          <span style="margin-top: 7px;" class="badge badge-danger navbar-badge hrm-navbar-badge total_notifications">0</span>
		        </a>
		        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(total_notifications == 0){
					$('.more_notifications').css('padding', '2px 7px;');
				}
