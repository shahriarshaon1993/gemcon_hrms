...
<header>
<style type="text/css">
	.o_home_menu .o_home_menu_scrollable {max-width: 100%; } .o_home_menu {height: auto; } .o_home_menu_background:not(.o_home_menu_background_custom) .o_main_navbar {background-color: #f1f1f1; border-color: #bbbbbb; } .profile-img img {max-width: 120px; max-height: 150px; } .profile-img img {display: inline-block; width: 100%; height: auto; background-repeat: no-repeat; background-position: center center; background-size: cover; border:1px solid #ddd; box-shadow: 0px 0px 5px 0px #919190; } .o_main_navbar > ul > li > a, .o_main_navbar > ul > li > label {color: #0a0a0a; } ul.menu li {display:inline; padding-left: 0px; } .employee-info p{margin-bottom: 0px; } .nav.nav-tabs {padding-left: 0px; } .nav-pills .nav-link {
		border: 1px solid #efefef; margin-bottom: 5px; color: #5f5e5e;
		    box-shadow: 0px 0px 2px 1px #e9ecef;
    border-top-color: #e9ecef; padding: 11px; } .pagination{margin-bottom: 0px; } .input-group-addon{border-top: 1px solid #ffa63d; padding: 6px; border-bottom: 1px solid #ffa63d; border-left: 1px solid #ffa63d; color: #ffffff; background: #ffa63d; } .nav-pills .nav-link.active, .nav-pills .show>.nav-link {color: #212529; background-color: whitesmoke; box-shadow: 0px 0px 2px 1px #ddd;     box-shadow: 0px 0px 2px 1px #e9ecef; border-top-color: #e9ecef; border-bottom: 3px solid #ffa63d; margin-bottom: -3px; padding: 11px; } .nav-pills .nav-link:focus, .nav-link:hover {color: #212529; background-color: whitesmoke; box-shadow: 0px 0px 2px 1px #ddd; transition: width 5s; } canvas {-moz-user-select: none; -webkit-user-select: none; -ms-user-select: none; } .o_home_menu {font-size: 14px; } @media (min-width: 768px){.employee-profile .col-md-2 {margin-left: 3px; }} .mega-dropdown {position: static !important; } .mega-dropdown-menu {padding: 20px 0px; width: 100%; box-shadow: none; -webkit-box-shadow: none; } .mega-dropdown-menu > li > ul {padding: 0; margin: 0; } .mega-dropdown-menu > li > ul > li {list-style: none; } .mega-dropdown-menu > li > ul > li > a {display: block; color: #222; padding: 3px 5px; } .mega-dropdown-menu > li ul > li > a:hover, .mega-dropdown-menu > li ul > li > a:focus {text-decoration: none; } .mega-dropdown-menu .dropdown-header {font-size: 18px; color: #ff3546; padding: 5px 60px 5px 5px; line-height: 30px; } .employee-info-table .table td, .table th {border: none !important; padding-bottom: 3px !important; } .paginate-pagination ul > li > a.page.active {opacity: 1; font-weight: bold; border-bottom: 2px solid #007bff; } .profile_file_img label{display: inline-block; padding: 0.5rem; font-family: sans-serif; border-radius: 0.3rem; cursor: pointer; margin-top: 1rem; position: absolute; text-align: center; top: 96px; left: 41px; } .fa-camera{font-size: 18px; border: 1px solid #888484; border-radius: 50px; padding: 5px; background: #fff;} .page-item.active .page-link {z-index: 3; color: #fff; background-color: #ffa63d; border-color: #ffa63d; } .page-link {position: relative; display: block; padding: .5rem .75rem; margin-left: -1px; line-height: 1.25; color: #0e0e0e; background-color: #fff; border: 1px solid #dee2e6; } .top-menu-list{position: absolute; left: 20%; top: 0; margin: 0px; padding: 0px; } .top-menu-list li{list-style: none; display: inline-block; margin-right: 10px; } .top-menu-list li a{color: #fff; line-height: 58px; padding: 16px 16px; position: relative; } .top-menu-list li a i{font-size: 28px; } .tooltiptext {visibility: hidden; width: 120px; background-color: black; color: #fff; text-align: center; border-radius: 6px; padding: 5px 0; /* Position the tooltip */ position: absolute; z-index: 1; left: 0; top: 90%; line-height: 20px; } .top-menu-list li a:hover .tooltiptext {visibility: visible; } .daterangepicker {margin-top: 0px; } .daterange-input input{border: 1px solid #ddd; margin-bottom: 7px; text-align: center; } .nav-tabs .nav-item.show .nav-link, .nav-tabs .nav-link.active {/*background: #fec23c;*/ box-shadow: 0px 0px 2px 1px #e9ecef; border-top-color: #e9ecef; border-bottom: 3px solid #ffa63d; margin-bottom: -3px; padding: 11px; font-size: 15px; } .nav-tabs .nav-link{padding: 11px; font-size: 15px; } .info-box .info-box-icon {width: 40px; height: 48px; margin-top: 0px; } .info-box .info-box-text, .info-box .progress-description {font-size: 16px; } .info-box .info-box-number {font-size: 24px; margin-top: 10px; } .info-box {padding: 15px 15px; } .nav-link {padding: 4px 30px; } .employee-profile {width: 90%; } .general-info .table td, .table th {padding: 2px; vertical-align: top; border-top: 0px solid #dee2e6; } @media (min-width: 768px){.col-md-2 {max-width: 12.5%; padding-top: 0px; } } .dropdown-item.active, .dropdown-item:active {color: #292a2b; text-decoration: none; background-color: #f5f5f5; } .leave-table.table-bordered td{padding-top: 7px; padding-bottom: 7px; text-align: center; } .notice-table.table-bordered td{padding-top: 0px; padding-bottom: 0px; text-align: center; } .paginate-pagination {position: relative; left: 1%;    width: 307% !important; } .select2-container {width: 100% !important; } .required_sign{color:red; } .dataTables_length label{display: inline-flex !important; } .grid_view_list{text-overflow: ellipsis; width:150px; overflow: hidden; white-space: nowrap; } .gj-timepicker-bootstrap [role=right-icon] button .gj-icon, .gj-timepicker-bootstrap [role=right-icon] button .material-icons {top: 4px !important; } input[type="text"], input[type="password"], textarea, select {outline: none !important; border: 1px solid#aaa !important; }
...
<nav class="o_main_navbar">
	<a href="/index" class="fa o_menu_toggle" title="Applications" aria-label="Applications"> 
		<?php 
			if(!empty($logos)){
		?>
		<img width="70" height="46" src="{{asset('company_logo/'.$logos)}}" style="margin-top:-3px;">
		<?php 
			}else{
		?>
	...
	<ul class="o_menu_systray" role="menu">
		<li class="dropdown">
			<!-- <a id="service_list_modal_open"  href="#"  class="nav-link" data-toggle="modal" data-target="#serviceList" data-whatever="@getbootstrap" data-backdrop="static" data-keyboard="false"><i class="fa fa-question-circle"></i> SERVICE REQUEST</a>	 -->
		...
		<!-- <li> 
			<a class="nav-link1"  href="{{url('/dashboards')}}" ><i class="fa fa-th-large"></i> ALL MODULE</a>
		</li> -->
		<li class="dropdown mega-dropdown">
			...
			<ul class="dropdown-menu mega-dropdown-menu o_home_menu">
				...
				<div class="o_apps">
					...
					<a class="o_app o_menuitem" href="{{url('/dashboards')}}">
...
<!-- <div class="o_loading" style="display: inline;">Loading</div> -->
...
<div class="o_home_menu_scrollable">
	...
	// echo "<pre>"; print_r($address_details); 
		...
		<div class="row clearfix employee-profile">
			<div class="col-md-12" style="margin-top:15px;">
				...
				<div class="col-md-2 col-6 float-left employee-info text-left" style="padding-right: 15px; min-width: 20%">
					...
					<p class="qr_code_data_2">{{isset($employee_data['designation_name'])?$employee_data['designation_name']:'Not Found!'}}</p>
				...
				<div class="col-md-3 col-12 float-left" style="min-width: 25% ;">
					...
					<p>
						...
						<i class="fa fa-address-card" style="color:orange;"></i>
							House No. {{isset($address_details['present_holding_no'])?$address_details['present_holding_no']:''}},
							Road No. {{isset($address_details['present_road_no'])?$address_details['present_road_no']:''}},
							{{isset($address_details['present_vill_area'])?$address_details['present_vill_area']:''}},
							{{isset($address_details['present_district'])?$address_details['present_district']:''}}
							<!-- {{isset($address_details['present_holding_no'])?$address_details['present_holding_no']:'Not Found!'}} -->
						</span>
					</p>
					
					<p style="padding-right: 30px; font-size: 13px;">
						<i class="fa fa-tint" style="color:orange;font-size: 18px"></i>
						 Blood Group <span style="background-color: #e04d4d; border-radius:4px; padding:0px 5px; color:#fff">{{isset($employee_data['employee_blood_group'])?$employee_data['employee_blood_group']:'Not Found!'}}</span>
					</p>
				</div>
				<div class="col-md-2 col-3 float-left  d-none d-sm-block text-center" style="margin:auto;">
					<div class="div_qr_print" style="margin-bottom: 5px;margin-left: 19% !important; margin-right: 19% !important;"></div>
					<!-- <?php //if (!empty($employee_data['employee_status'] && $employee_data['employee_status']==1)): ?>
						<button class="btn btn-sm btn-success text-center" style="width: 80px;border-radius: 10px; padding:0px;margin-left: -58px;margin-top: 2px;margin-bottom: -2px;"><storng style="color:#fff; font-size:12px;">
							Active
						</storng></button>
					<?php// else: ?>
						<button class="btn btn-sm btn-danger text-center" style="width: 80px;border-radius: 10px; padding:0px;margin-left: -58px;margin-top: 2px;margin-bottom: -2px;"><storng style="color:#fff; font-size:12px;">
							Inactive
						</storng></button>
					<?php //endif ?> -->
					<script type="text/javascript">
						var employee_data = $(".qr_code_data_1").text()
						+','+$(".qr_code_data_2").text()
						+','+$(".qr_code_data_3").text()
						+','+$(".qr_code_data_4").text()
						// +','+$(".qr_code_data_5").text()
				...
				<div class="col-md-2 col-12 float-right" style="min-width: 25% ">
					<table class="table table-striped table-bordered notice-table" cellspacing="0" width="100%" style="font-size:12px;height: 72px;margin-bottom:0px">
					  <thead >
					    <tr>
					      ...
					      <th colspan="2" class="text-right" style="padding-right:15px;">
					      </th>
					    </tr>
					  </thead>
					  <tbody>
					  	 <tr style="text-align: left;">
					  		<td colspan="5" style="padding-left:0px;padding-right:0px; height: 39px"><!-- Group IT -->
					  		<div id="carouselExampleControls" class="carousel slide vertical" data-ride="carousel" style="width: 100%;">
					  		  <div class="carousel-inner">
					  		    ...
					  		    <div class="carousel-item <?php if($i==1){echo 'active';} ?>" style="padding:0px;">
					  		    	<table cellspacing="0" width="100%">
					  		    		<tr>
								  		<!-- <td colspan="2"><strong>{{ date('d,M',strtotime($value['notice_sdate']))}}</strong></td> -->
								  		<td colspan="5" style="text-align: left;">{{$value['notice_title'] }}</td>
								  		<td>  
								  			<a href="#" style="color: orange" data-toggle="modal" data-target="#NoticeList" id="viewNoticeDetails" 
						  		  			data-notice_title = "<?php echo $value['notice_title']; ?>"
						  		  			data-notice_details = "{{ $value['notice_details']}}"
						  		  			>
						  		  			<i class="fa fa-eye"></i> 
			  		  						</a>
								  		</td>
					...
					<?php 
					// echo "<pre>"; print_r($today_birthday_info); die();
					 ?>
					<table class="table table-striped table-bordered notice-table" cellspacing="0" width="100%" style="font-size:12px;height: 53px;margin-top: 10px;margin-bottom:0px">
					  ...
					  <tbody>
					  	<tr style="text-align: left;">
					  		<td colspan="4" style="padding-left:0px;padding-right:0px;"><!-- Group IT -->
					  		<div id="carouselExampleControls" class="carousel slide vertical" data-ride="carousel" style="width: 100%;">
					  		  <div class="carousel-inner">
					  		  	<?php 
					  		    ...
					  		    <div class="carousel-item <?php if($i==1){echo 'active';} ?>" style="padding:0px;">
					  		    	<div class="col-md-2 float-left" style="margin-left: 0px; padding:0px;" >
					  		    		<i class="fa fa-user"></i>
					  		    	</div>
					  		    	<div class="col-md-4 float-left" style="margin-left: 0px; padding:0px;">
											<?php echo $value['employee_fullname']; ?>
						  		    	</div>
					  		    	<div class="col-md-3 float-left" style="margin-left: 0px; padding:0px;">
			...
			<div class="col-md-12" style="padding: 0px;">
				...
				<div class="tab-content" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
						...
						// if (!empty($ajax_from)) {
							# code...
							// $date =date('Y-m-d', strtotime($ajax_from));
							// echo "<pre>"; print_r($date); echo "<pre>";
							// echo "<pre>"; each(array)cho $ajax_to; die();
						// }
						 ?>
						 <?php
						 // foreach ($ind_leave_info as $key => $value) {
						 // 	if('2020-11-25'== $value['leave_from_date']){
						 // 		echo "exists";
						 // 		echo "<br>";
						 // 	}
						  // echo '<pre>';  print_r($ind_leave_info); die();
						 // }
						 // in_array(needle, $ind_leave_info)
						   ?>
						<div class="row">
							...
							<!-- <div class="col-md-12" style="height: 400px; border: 1px solid #aaa;">	 -->
								<form action="{{URL::to('/index')}}" method="get" id='formId'>
									<div class="col-md-3 float-left daterange-input" style="padding:0px;">
										    <input style="height: 22px;" name="from_date" type="text" class="form-control datepicker from_date_alert" placeholder="From" value="<?php if(!empty($ajax_from_date)){echo $ajax_from_date;} ?>">
									</div>
									<div class="col-md-3 float-left daterange-input" style="padding:0px;">
										    <input style="height: 22px;" id="datepickerto" name="to_date" type="text" class="form-control datepicker to_date_alert" placeholder="To" value="<?php if(!empty($ajax_to_date)){echo $ajax_to_date;} ?>">
									</div>
								</form>
								<div class="col-md-1 float-left">
									<a href="/index"><i class="fa fa-refresh" aria-hidden="false"></i></a>
								</div>
										    ...
										    <tr >
										      ...
										      <td class="text-center">
										      	<?php if ($att_value['statusId']==1){
										      		...
										      		echo "<span class='btn btn-xs bg-dark' style='height:25px;color:#ddd;font-weight:bold' title='Weekend'>". $att_value['Status'] ."</span>";
							...
							<div class="col-md-6 col-sm-12 col-xs-12 float-left">
								...
								<div class="col-md-12 table-responsive" style="padding:0px">
									<table id="dtBasicExample" class="table table-striped table-bordered leave-table" cellspacing="0" style="font-size:12px;width: 99.9%;">
									  <thead >
									    <tr>
									      <th colspan="6" class="th-sm text-left">	
									  ...
									  <tbody>
									  	<tr>
									  		...
									  		<td rowspan="2" style="vertical-align: middle;background: #fff;">
									  			<!-- <button class="btn btn-warning leaveCalendar"> -->
									  	...
									  	<tr>
									  		...
									  		<td rowspan="2" style="vertical-align: middle;background: #fff;">
									  				...
									  				<!-- <a class="btn btn-warning"  data-toggle="modal" id="add_appointment" href="#modal_form_addappt" data-whatever="@getbootstrap"  style="color:#212529; text-decoration: none;width: 104px;">
									  					Apply Leave
									  				</a> -->
									  				<a class="btn btn-warning"  href="#" data-toggle="modal" data-target="#applyLeave" data-whatever="@getbootstrap"  style="color:#212529; text-decoration: none;width: 104px;">
									  					Apply Leave
									  				</a>
									  		</td>
									  	</tr>
...
<div class="tab-pane fade " id="my-profile" role="tabpanel" aria-labelledby="profile-tab" style="padding-left:0px;">
<div class="">
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" style="padding-top: 0px;">
                    <div class="form-group" style="margin:0px;">
            			...
            			<?php 
            				// echo "<pre>"; print_r($others_contact_details); die();
                ...
                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab" style="padding-top: 0px;">
					...
					<div class="tab-pane fade" id="file-manager" role="tabpanel" aria-labelledby="tab5">
						<div class="col-md-12 table-responsive folder_list_section" style="padding-bottom: 15px;">
							<h5 style="margin-bottom: 25px;">
							 ...
							 <!-- <label style="margin-bottom: 25px; width: 100%">
                                ...
                                <input type="text" style=" background: #ffc10724;border-radius: 0px 5px 5px 0px;box-shadow: 0 0 0 0rem rgb(0 123 255 / 0%);" name="serach" id="serach" class="form-control" placeholder="Search Folder " />
                                </div>
                        	</label>  -->
					...
					<div class="tab-pane fade" id="assets" role="tabpanel" aria-labelledby="tab4">
						<div class="col-md-12" style="padding: 0px;">
						<ul class="nav nav-tabs" id="myTab" role="tablist" >
							<li class="nav-item">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="CurrentAssets" style="padding:0px;" role="tabpanel" aria-labelledby="home-tab1">
					        ...
					        <table id="assetsTable" class="table table-striped table-bordered fileListTable assetsListTable" cellspacing="0" style="font-size:12px; border: none;">
					            <thead>
					                <tr class="text-center">
					                    <th scope='col' style='border:1px solid #ddd !important;'>#</th>
					...
					<div class="tab-pane fade" id="kpi-performance" role="tabpanel" aria-labelledby="contact-tab">
						Under Development 3
					</div>
					<div class="tab-pane fade" id="payroll" role="tabpanel" aria-labelledby="tab5">
						Under Development 5
					</div>
					<div class="tab-pane fade" id="employee-directory" role="tabpanel" aria-labelledby="tab5">
						<div class="row">
							<div class="col-md-9 table-responsive" style="margin-bottom: -14px;">
								<h5 style="margin-bottom: 25px;"><i class="fa fa-bars"></i> Employee Directory
									<span style="float: right; padding-left: 15px;">
										<button class="btn btn-warning"href="#" data-toggle="modal" data-target="#pabxNoModal" data-whatever="@getbootstrap" >PABX</button>
									</span>
								 ...
								 <label style="margin-bottom: 25px; width: 100%">
                                    <div class="input-group"><span style="font-size: 19px;border-radius: 5px 0px 0px 5px;" class="input-group-addon"><i class="fa fa-search"></i></span>
                                    <input type="text" style=" background: #ffc10724;border-radius: 0px 5px 5px 0px;box-shadow: 0 0 0 0rem rgb(0 123 255 / 0%);" name="serach" id="serach" class="form-control" placeholder="Search Employee (ID or Name) Min 5 Digit " />
                                    </div>
                            	</label> 
								<!-- <h5 >
							...
							<div class="col-md-3" style="border: 1px solid #e0e0e0;padding:0px;">
								...
								<div class="col-md-12 employee_directory_profile" style="text-align: center;margin-top:30px;">
									<?php //if (file_exists(asset('images/'.$employee_image ))): ?>
									<?php if (!empty($employee_image) && file_exists(public_path('images/'.$employee_image))): ?>
									...
									<?php endif ?>
									<h1 class="qr_code_data_1" style="font-size:20px; font-weight: bold; margin-top: 15px; margin-bottom: 0px;">
									...
									<p  class="qr_code_data_2" style="margin-bottom: 2px;">
										<span id="designation_name">{{isset($employee_data['designation_name'])?$employee_data['designation_name']:'Not Found!' }}</span>, <span id="section_name" >{{ isset($employee_data['section_name'])?$employee_data['section_name']:''}}</span>
									</p>
									<!-- <span >
									...
									<div class="col-md-12 float-left text-left" style="padding:0px;margin-top: 30px; ">
										<p style="margin-bottom:4px;">
											<?php 
											$employee_dob_actual = isset($employee_data['employee_dob_actual'])?$employee_data['employee_dob_actual']:'';
											
											 ?>
											<i class="fa fa-birthday-cake" style="color:orange;     padding-right:5px;"></i> 
											<span id="employee_dob_actual"  class="qr_code_data_7"><?php echo date('d F', strtotime($employee_dob_actual)); ?>
										...
										<p style="padding-right: 30px; font-size: 13px; margin-bottom:4px;">
											...
											<span id="employee_blood_group"  style="background-color: #e04d4d; border-radius:4px; padding:0px 5px; color:#fff">{{isset($employee_data['employee_blood_group'])?$employee_data['employee_blood_group']:'Not Found!'}}
											</span>
										</p>
										<p style="margin-bottom:4px;" >
											<?php 
  		...
  		<table class="table table-striped table-bordered leave-table" cellspacing="0" width="100%" style="font-size:12px;">
  		  ...
  		  <tbody>
  		  	...
  		  	<tr>
  		  		...
  		  		<td><?php echo $value['employee_fullname']; ?></td>
...
<div class="modal-content">
  <div class="modal-header">
    <h5 class="col-md-3 modal-title" id="birthdayListLabel" style="padding-left: 0px;"><i class="fa fa-list"></i> Notice</h5>
    <div class="col-md-8 text-right detailsNotice" style="display: none;">
  				<a href="#" id="backToNlist" style="color: orange;"><i class="fa fa-backward"></i> Back to List</a>
  			</div>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="false">&times;</span>
    </button>
  		 ...
  		 <!--  <thead >
  		  ...
  		  <tbody>
  		  	...
  		  	<tr>
  		  		...
  		  		<td style="text-align: left;"><p style="text-overflow: ellipsis;text-align: left;width: 182px;overflow: hidden;white-space: nowrap;"> <?php echo limit_text($value['notice_details'], 10); ?> </p></td>
  		  		<!-- limit_text -->
  		  		<td>
  		  			<a href="#" style="color: orange;" id="viewNoticeDetails" 
  		  			data-notice_title = "<?php echo $value['notice_title']; ?>"
  		  			data-notice_details = "{{ $value['notice_details']}}"
  		  			>
  		  				<i class="fa fa-eye"></i> 
...
<div class="modal-content">
  <div class="modal-header">
    <h4 class="col-md-9" v-if="add_new_type!=5"><i class="fa fa-bars"></i> Leave Application</h4>
  ...
  <div class="modal-body">
	...
	<div class="col-md-12" >
		<div class="row col-md-12" style="padding:5px;">
					...
					<tbody>
						<tr>
							...
							<td style="padding: 0.5rem;">
								<input type="hidden" name="" value="<?php echo $employee_data['id'] ?>"><?php echo $employee_data['employee_id_no'] ?></td>
						</tr>
						<tr>
							<td style="padding: 0.5rem;">Employee Name</td>
							<td style="padding: 0.5rem;">:</td>
							<td style="padding: 0.5rem;"><?php echo $employee_data['employee_fullname'] ?></td>
						</tr>
						<tr>
							<td style="padding: 0.5rem;">Designation</td>
							<td style="padding: 0.5rem;">:</td>
							<td style="padding: 0.5rem;"><?php echo $employee_data['designation_name'] ?></td>
						</tr>
						<tr>
							<td style="padding: 0.5rem;">Department</td>
							<td style="padding: 0.5rem;">:</td>
							<td style="padding: 0.5rem;"><?php echo $employee_data['department_name'] ?></td>
						</tr>
						<tr>
							<td style="padding: 0.5rem;">Company/SBU/Project</td>
							<td style="padding: 0.5rem;">:</td>
							<td style="padding: 0.5rem;"><?php echo $employee_data['sbu_name'] ?></td>
						</tr>
						<tr>
							<td style="padding: 0.5rem;">Contact Phone</td>
							<td style="padding: 0.5rem;">:</td>
							<td style="padding: 0.5rem;"><?php echo $employee_data['employee_mobile'] ?></td>
						</tr>
					</tbody>
				</table>
			</div>
			<div  class="col-md-3 leave-info text-center" style="margin:auto;">
				<span id="leave_info_div"  style="display: none;">
				  <h5 style="font-size: 16px; font-weight: bold;"><span id="tleave_day_no"></span> Days of <span id="leave_type_name_id"></span> Leave</h5>
		...
		<?php //echo "<pre>"; print_r($leave_type_data); die(); ?>
		<span>
					...
					<div class="col-md-12" style="padding:0px;">
						<div class="col-md-7 float-left" style="padding:0px;">
								...
								<div class="col-md-8 float-left inputGroupContainer" style="padding: 0px;">
									<div class="input-group" id="leave_type_id_select2">
										...
										<select id="leave_type_id" name="leave_type" class="js-example-basic-single" name="state">
										  ...
										  <?php foreach ($leave_type_data as $key => $value): ?>
							...
							<div class="row form-group col-md-12" style="margin-bottom: 20px !important;">
								...
								<div class="col-md-8 float-left inputGroupContainer" style="padding: 0px;">
									<div class="input-group">
										<textarea  name="leave_reason" placeholder="" required="required" type="text" class="form-control"></textarea>
									</div>
								</div>
							</div>
							<div class="row form-group col-md-12" style="margin-bottom: 20px !important;">
								...
								<div class="col-md-8 float-left inputGroupContainer" style="padding: 0px;">
									<div class="input-group">
										<!-- <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>  -->
										<textarea  name="address_leave" placeholder="" class="form-control"></textarea>
									</div>
								</div>
							</div>
							<div class="row form-group col-md-12" style="margin-bottom: 20px !important;">
								<div class="col-md-4 float-left" style="padding-left: 0px;">
									<label class="control-label">Responsible<span class="required_sign">*</span>
									</label>
								</div>
								<div class="col-md-8 float-left inputGroupContainer" style="padding: 0px;">
									<div class="input-group">
							...
							<div class="row form-group col-md-12" style="margin-bottom: 20px !important;">
								<div class="col-md-4 float-left" style="padding-left: 0px;padding-right: 0px;">
									<label class="control-label">Responsible Contact <span class="required_sign">*</span>
									</label>
								</div>
								<div class="col-md-8 float-left inputGroupContainer" style="padding: 0px;">
									<div class="input-group" >
										<!-- <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>  -->
										<input id="rsp_employee_mobile" name="leave_reliever_contact" placeholder="" required="required" type="number" class="form-control">
									</div>
								</div>
							</div>
							...
							<div class="col-md-5 float-left" style="padding:0px;">
								...
								<!-- <input type="text" readonly="readonly" style="border: none; background: transparent;">
								<br>
								<input type="text" readonly="readonly" style="border: none; background: transparent;"> -->
								<div class="row form-group col-md-12" style="margin-bottom: 20px !important;">
...
<!-- <input type="hidden" name="leave_holiday" value="0" class="leave_holiday"> -->
</div>
...
<!---->
  ...
  <div class="modal-footer">
    <div class="form-actions col-md-12">
    	<input type="submit" tabindex="4" value="Apply" class="btn btn-sm btn-info float-right col-md-2" style="font-size: 14px; padding-bottom: 3px;">
    	<button type="button" class="btn btn-sm btn-default float-right col-md-2 offset-md-6 close" data-dismiss="modal" aria-label="Close" style="font-size: 14px; margin-top: 0px;background: #e9e9e9;    padding: 6px;margin-right: 3px;    color: #000;border: 1px solid #aaa;">Cancel</button>
    </div>
  </div>
 </form>
</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
									...
									<div class="col-md-8 float-left inputGroupContainer" style="padding-right: 0px;">
										<div class="form-group datepicker-container">
											...
											<div class="col-md-6 float-left" style="padding: 0px;">
												<div class="input-group">
													<div class="col-md-12" style="padding: 0px;">
														<input name="service_date_to" type="date" style="width: 92%;">
													</div>
												</div>
											</div>
										</div>
			  ...
			  <div class="modal-footer" style="padding: 10px 35px;">
			    ...
			    <button class="backToServiceList" type="submit" class="btn btn-info updateRequestBtn" style="display: none;">Update Request</button>
			  </div>
			</div>
		</div>
	</form>
						...
						<div class="col-md-12" style="padding:0px;">
							<div class="col-md-12 float-left" style="padding:0px;">
								<div class="row form-group col-md-12" style="margin-bottom: 20px !important; margin:0px;">
									...
									<div class="col-md-8 float-left inputGroupContainer" >
										<div class="input-group service_select">
											<select id="service_type_id" name="manual_attendance_issues"  name="state" style="padding-left:5px; height: 27px; border-radius:.25rem;">
											  <option class="select_service_type">--Select--</option>
									...
									<div class="col-md-8 float-left inputGroupContainer" style="padding-right: 0px;">
										<div class="form-group datepicker-container">
											<div class="col-md-12 float-left" style="padding-left:0px;">
												<div class="input-group">
													<div class="col-md-12" style="padding: 0px;">
														<input name="manual_attendance_date" type="date" style="width: 100%;">
													</div>
												</div>
											</div>
										</div>
			  ...
			  <div class="modal-body">
					<input name="employee_id" type="hidden" value="<?php echo $employee_data['employee_id'] ?>">
			  		...
			  		<!-- <ul class="nav nav-tabs" id="myTab" role="tablist" style="padding-left: 5px;">
			  			<li class="nav-item">
			  				<a class="nav-link active" id="present-tab" data-toggle="tab" href="#service_list_tab" role="tab" aria-controls="present" aria-selected="false">Service List</a>
			  			</li>
			  			<li class="nav-item">
			  				<a class="nav-link " id="home-tab" data-toggle="tab" href="#late_approve_tab" role="tab" aria-controls="home" aria-selected="true">Others Tab</a>
			  			</li>
			  			<li class="nav-item">
			  				<a class="nav-link " id="home-tab" data-toggle="tab" href="#leave_list_tab" role="tab" aria-controls="home" aria-selected="true">Others Tab</a>
			  			</li>
			  		</ul> -->
			  		<div class="tab-content" id="myTabContent">
	  				        ...
	  				        <table class="table table-striped table-bordered serviceListTable" cellspacing="0" width="100%" style="font-size:12px; border: none;	" >
	  				            <thead>
	  				                <tr class="text-center">
	  				                    ...
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Serv. Type</th>
			  			...
			  			<div class="tab-pane fade" id="late_approve_tab" role="tabpanel" aria-labelledby="contact-tab" style="padding: 0px;">
			  				<!-- <h4 class='text-center' style="margin-top:10px;">Late Approve List</h4>
	  				        <table class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size:12px; border: none;	">
	  				            <thead>
	  				                <tr class="text-center">
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>#</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Attendance Date</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>In Time</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Actual In Time</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Reason</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Status</th>
	  				                </tr>
	  				            </thead>
	  				            <tbody id='lateApproveAppend'>

	  				            </tbody>
	  				        </table> -->
			  			</div>
			  			<div class="tab-pane fade" id="leave_list_tab" role="tabpanel" aria-labelledby="contact-tab" style="padding: 0px;">
			  				<!-- <h4 class='text-center' style="margin-top:10px;">Leave List</h4> -->
	  				        <!-- <table class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size:12px; border: none;	">
	  				            <thead>
	  				                <tr class="text-center">
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>#</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Apply Date </th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Type</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Date</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Days</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Reason</th>
	  				                    <th scope='col' style='border:1px solid #ddd !important;'>Status</th>
	  				                </tr>
	  				            </thead>
	  				            <tbody id='leaveAppendData'>
...
$("#change_leave_to_date").on('change keyup paste', function() {
		...
		if (date1 == 'Invalid Date') {
			alert('Please select from date first!');exit();
		}
		...
		var leave_type_id = $('#leave_type_id').find('option:selected').val();
	  	...
	  	leave_type_info =leave_type_info.find(data => data.leave_type == leave_type_id);
	  	tleave_day_no = leave_type_info.leave_day_no;
...
$("#service_list_modal_open").on('click', function() {
	...
	// $(document).on('click','.assetsInfoId', function(){
	// 	$('.assetsListTable').toggle(1000);
	// });
