            ...
            <div id="navbar" class="websdktest">
                <form class="navbar-form navbar-right" id="meeting_form">
                    <div class="form-group">
                        <input type="text" name="display_name" id="display_name" value="1.8.5#CDN" maxLength="100"
                    ...
                    <input type="hidden" id="copy_link_value" />
...
<!--     <script src="js/tool.js"></script>
    ...
    <script src="{{asset('zoom_asset/js/tool.js')}}"></script>
    <script src="{{asset('zoom_asset/js/vconsole.min.js')}}"></script>
    <script src="{{asset('zoom_asset/js/index.js')}}"></script>
