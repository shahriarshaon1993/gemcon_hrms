...
Route::get('/career', 'JobsController@viewAllJobs')->name('career');
Route::post('/jobApply', 'JobsController@jobApply')->name('jobApply');
...
function hrmRoute()
{
	...
	Route::get('/onlyShortList/job_circular/{id}', 'JobCircularController@onlyShortList');
	Route::get('/unListed/job_circular/{id}', 'JobCircularController@unListed');
	Route::get('/shortListNemail/job_circular/{id}/{name}/{email}', 'JobCircularController@shortListNemail');
	Route::get('/selectCandidate/job_circular/{id}', 'JobCircularController@selectCandidate');
	Route::get('/rejectCandidate/job_circular/{id}', 'JobCircularController@rejectCandidate');
	...
	Route::post('/marksEntry/interview_board_call', 'InterveiwBoardCallController@marksEntry');
...
function payrollRoute()
{
	...
	// Route::post('/bonus_process/find_employee_data','DailyProductionController@find_employee_data');
	...
	// Route::POST('/pay_slip_report/{id}', 'PayrollListController@pay_slip_details');
	// 'PayrollListController@pay_slip_details'
